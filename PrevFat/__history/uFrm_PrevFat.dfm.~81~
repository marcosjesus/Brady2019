object Frm_Previsao: TFrm_Previsao
    ...
    object TabCopia: TcxTabSheet
      ...
      object cxGridEmail: TcxGrid
        ...
        object cxTableViewEmail: TcxGridDBTableView
          ...
          DataController.DataSource = DataSourceEmail
          DataController.Filter.Active = True
          DataController.KeyFieldNames = 'TSOP_EMAILCOD'
          ...
          object cxTableViewEmailTSOP_EMAIL: TcxGridDBColumn
            Caption = 'E-mail'
            DataBinding.FieldName = 'TSOP_EMAIL'
            Width = 426
          end
          object cxTableViewEmailTSOP_ATIVO: TcxGridDBColumn
            Caption = 'Ativo'
            DataBinding.FieldName = 'TSOP_ATIVO'
            Width = 74
          end
        end
        object cxGridLevelEmail: TcxGridLevel
          Caption = 'Cadastro de E-mail (CC)'
          GridView = cxTableViewEmail
        end
      end
    end
  end
  ...
  object FDQueryEmail: TFDQuery
    ...
    object FDQueryEmailTSOP_PROGRAMA: TStringField
      FieldName = 'TSOP_PROGRAMA'
      Origin = 'TSOP_PROGRAMA'
      Size = 255
    end
    object FDQueryEmailTSOP_EMAIL: TStringField
      FieldName = 'TSOP_EMAIL'
      Origin = 'TSOP_EMAIL'
      Size = 255
    end
    object FDQueryEmailTSOP_ATIVO: TStringField
      FieldName = 'TSOP_ATIVO'
      Origin = 'TSOP_ATIVO'
      FixedChar = True
      Size = 1
    end
