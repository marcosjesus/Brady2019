...
begin
  ...
  try
    ...
    if varColumnFilial = -1 then
      ShowMessage( 'Coluna (FILIAL) não foi encontrada' );
    if varColumnNF = -1 then
      ShowMessage( 'Coluna (NUM. NF) não foi encontrada' );
    if varColumnDataNF = -1 then
      ShowMessage( 'Coluna (DATA NF) não foi encontrada' );
    if varColumnCFOP = -1 then
      ShowMessage( 'Coluna (CFOP) não foi encontrada' );
    if varColumnUF = -1 then
      ShowMessage( 'Coluna (UF) não foi encontrada' );
    if varColumnValorContabil = -1 then
      ShowMessage( 'Coluna (VLR. CONTABIL) não foi encontrada' );
    if varColumnValorICMS = -1 then
      ShowMessage( 'Coluna (VLR. ICMS) não foi encontrada' );
    if varColumnAliq_PIS = -1 then
      ShowMessage( 'Coluna (ALIQ PIS) não foi encontrada' );
    if varColumnAliq_COFINS = -1 then
      ShowMessage( 'Coluna (ALIQ COFINS) não foi encontrada' );
    if varColumnCodProduto = -1 then
      ShowMessage( 'Coluna (COD. PRODUTO) não foi encontrada' );
    if varColumnNovaBase = -1 then
      ShowMessage( 'Coluna (NOVA BASE PIS/COFINS) não foi encontrada' );
    if varColumnNovoValorPIS = -1 then
      ShowMessage( 'Coluna (NOVO PIS) não foi encontrada' );
    if varColumnNovoValorCOFINS = -1 then
      ShowMessage( 'Coluna (NOVO COFINS) não foi encontrada' );
