...
//  if not DirExists( IncludeTrailingPathDelimiter( varFolderSistema )  ) then
  ...
  begin
     Writeln( varFolderSistema + 'MLParametros.ini' + 'Arquivo de Configuração das Pastas.' );
     Exit;
  end;
  ...
  Try
      ...
      begin
        Writeln( varFolderSistema + 'MLParametros.ini' + 'Arquivo de Configuração de Conta de E-mail não encontrado.' );
        Exit;
      end;
    ...
    //  Writeln( 'Criando DataModule' );
      ...
      begin
         ...
         begin
            Writeln( ' Não há Conta de E-mail Configurada no Sistema. Processo será abortado' );
            Exit;
         end;
                                                         ...
                                                         begin
                                                           ...
                                                           try
                                                              ...
                                                              Try
                                                                  ...
                                                                  DB_Conect.doSaveLogImport(PastaLOG, 'Arquivo Inválido ' +  PWideChar(  PChar(varTmp) ));
  ...
  Try
    ...
    //    varFolderSistema := 'T:\';
      ...
      begin
          ...
          begin
            lContinua := False;
            Writeln( 'DB_MLSistemas.ini - ' + pchar('Caminho ' + varFolderSistema + ' não encontrado!!!') );
          end
          else
          begin
            lContinua := True;
                   ...
                   Try
                     ...
                     begin
                             ...
                             begin
                                ...
                                begin
                                    ...
                                    begin
                                          ...
                                          if FD_BuscaFilial.IsEmpty then
                                          begin
                                            DB_Conect.doSaveLogImport(PastaLOG, lArquivo  + ' - NF Entrada - Filial Não Cadastrada');
                                            Continue;
                                          end;
                                    end;
                              ...
                              begin
                                ...
                                begin
                                 ...
                                 begin
                                      ...
                                      begin
                                          DB_Conect.doSaveLogImport( PastaLOG , lArquivo  + ' - CNPJ Não Cadastrado.');
                                          Continue;
                                      end;
                                 end
                                 else
                      ...
                      //           FD_Insert_EntregaXML.ParamByName('Fone').AsString                    := Dest.enderDest.fone;
                          ...
                          //  DB_Conect.DB_Conect.doSaveLogImport(lPathLog, ' Arquivo ' + rgXML.Properties.Items[rgXML.ItemIndex].Caption  + ' Inválido ' + PWideChar(  lPath +  sr.Name ));
                            Continue;
                          end;
                        end;
                        varSQL := '';
                           ...
                           Try
                            ...
                            try
                              XMLDoc.LoadFromFile(PastaXML +  sr.Name);
                               ...
                               DB_Conect.doSaveLogImport(PastaLOG, 'Arquivo Inválido ' +  PWideChar(  PastaXML_LIDO +  sr.Name ));
                            ...
                            Try
                               ...
                               infEvento := retEvento.ChildNodes.FindNode('infEvento');
                                 ...
                                 DB_Conect.doSaveLogImport(PastaLOG, 'Nó Inválido ' +  PWideChar(  PastaXML +  sr.Name ));
                                 Writeln( 'Nó Invalido: ' +  PWideChar(  PastaXML +  sr.Name ) );
                                 DeleteFile(PastaXML  +  sr.Name);
                                 searchResult := FindNext(sr);
                                 Continue;
                            End;
