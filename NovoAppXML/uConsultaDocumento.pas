      ...
      Application.MessageBox('Dados de NF-e não encontrados.', 'Consultar - NF-e', mb_iconinformation +  MB_OK);
       ...
       begin
          ...
          if sqlConsultaCTE.IsEmpty then
             Application.MessageBox('Dados de CT-e não encontrados.', 'Consultar - CT-e', mb_iconinformation +  MB_OK);
...
begin
  ...
  begin
    ...
    if sqlConsultaCTE.IsEmpty then
    begin
        Application.MessageBox('Não há dados de CT-e para serem exportados.', 'Exportar para Excel - CTe', mb_iconinformation +  MB_OK);
        Exit;
    end;
