  ...
  object FDQueryGrid: TFDQuery
    ...
    SQL.Strings = (
      ...
      'SELECT C.ORDEM,  C.CODIGO_LINHA, C.DESC_L210,C.SUBGRUPO,'
        ...
        '             (SUM(M.VALOR_FIS_01)  + SUM(M.VALOR_FIS_02) + SUM(M' +
        '.VALOR_FIS_03) + SUM(M.VALOR_FIS_04) + SUM(M.VALOR_FIS_05) + SUM' +
        '(M.VALOR_FIS_06)) JANEIRO,'
      
        #9'    (SUM(M.VALOR_FIS_01)  + SUM(M.VALOR_FIS_02) + SUM(M.VALOR_F' +
      ...
      #9#9'SUM([006]) + SUM([007]) AS '#39'FEVEREIRO'#39', '
      #9#9'SUM([006]) + SUM([007]) + SUM([008]) AS '#39'MAR'#199'O'#39', '
      #9#9'SUM([006]) + SUM([007]) + SUM([008]) + SUM([009]) AS '#39'ABRIL'#39', '
      
        #9#9'SUM([006]) + SUM([007]) + SUM([008]) + SUM([009]) + SUM([010])' +
        ' AS '#39'MAIO'#39','
      
        #9#9'SUM([006]) + SUM([007]) + SUM([008]) + SUM([009]) + SUM([010])' +
        ' + SUM([011]) AS '#39'JUNHO'#39', '
      ...
      'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) AS MARCO, '
        ...
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) AS MAIO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) AS JUNHO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) AS JULHO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) + SUM(AGOSTO) AS AGOSTO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) + SUM(AGOSTO) + SUM(SETEMBRO) AS S' +
        'ETEMBRO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) + SUM(AGOSTO) + SUM(SETEMBRO) + SU' +
        'M(OUTUBRO) AS OUTUBRO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) + SUM(AGOSTO) + SUM(SETEMBRO) + SU' +
        'M(OUTUBRO) + SUM(NOVEMBRO) AS NOVEMBRO, '
      
        'SUM(JANEIRO) + SUM(FEVEREIRO) + SUM(MARCO) + SUM(ABRIL) + SUM(MA' +
        'IO) + SUM(JUNHO) + SUM(JULHO) + SUM(AGOSTO) + SUM(SETEMBRO) + SU' +
        'M(OUTUBRO) + SUM(NOVEMBRO) + SUM(DEZEMBRO) AS DEZEMBRO'
      ''
      ''
      'FROM ('
