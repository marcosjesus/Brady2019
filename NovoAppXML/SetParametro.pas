...
type
  TTipoConsulta = (TipoProduto, TipoProdutoVendas, TipoCliente, TipoFornecedorX, TipoItensFaturado, TipoProdutoFornecedor, TipoCompras,
                   ...
                   TipoFornecedorID, TipoPeriodicidadeID, TipoTpTreinamentoID, TipoFilialID, TipoInstrutorID,  TipoContaSaldo,
                   TipoTreinamentoID, TipoPerfil, TipoOperacao,TipoUsuarioID, TipoParticipanteID, TipoParticipanteCad,
                   TipoCentroCustoID, TipoCargoID, TipoParticipanteFILIAL, TipoCFOPCC,TipoApuracao,TipoECFConta,TipoECFCentroCusto, TipoECFVinculo,
                   TipoTP_CentroCusto, Tipo_ConsultaSAP);
...
begin
  ...
  if TipoConsulta = Tipo_ConsultaSAP then
  begin
    CaixaTexto.bs_Caption := 'Consulta do SAP';
    CaixaTexto.bs_Table := 'ECF_CONSULTA With (NOLOCK)';

    CaixaTexto.bs_Fields.Add('ECF_CONSULTA_ID;ID;;' + inttostr(WIDTH_CODIGO));
    CaixaTexto.bs_Fields.Add('NOME;Nome da Consulta;;' + inttostr(WIDTH_NOME));                    //0
    CaixaTexto.bs_Fields.Add('USUARIO_SAP;Usuário do SAP;;' + inttostr(WIDTH_DOCUMENTO));                    //0
  ...
  if TipoConsulta = TipoContaSaldo then
  begin
    CaixaTexto.bs_Caption := 'Lançamento de Saldo da Conta';
    CaixaTexto.bs_Table := 'ECF_CONTA_SALDO CS With (NOLOCK)';

    CaixaTexto.bs_Fields.Add('C.NUMERO_CONTA;Conta;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('CS.EXERCICIO;Exercício;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('CS.PERIODO_FISCAL;Período;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('CS.SALDO;Saldo;;'  + inttostr(WIDTH_CODIGO35));


    CaixaTexto.bs_Fields.Add('CS.ECF_CONTA_SALDO_ID;#;;' + inttostr(WIDTH_DOCUMENTO));



    CaixaTexto.bs_Join := ' Inner Join ECF_CONTA C on C.ECF_CONTA_ID = CS.ECF_CONTA_ID ';


    CaixaTexto.bs_TextResult := 'ECF_CONTA_SALDO_ID';
    CaixaTexto.bs_KeyField   := 'ECF_CONTA_SALDO_ID';
  end
  else
  if TipoConsulta = TipoECFVinculo then
  begin
    CaixaTexto.bs_Caption := 'Vincular Conta ao Centro de Custo';
    CaixaTexto.bs_Table := 'ECF_VINCULO V With (NOLOCK)';

    CaixaTexto.bs_Fields.Add('C.NUMERO_CONTA;Conta;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('CC.CENTRO_CUSTO;Centro de Custo Principal;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('C2.CENTRO_CUSTO;Centro de Custo ;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('V.PERCENTUAL*100;%;;' + inttostr(WIDTH_DOCUMENTO));

    CaixaTexto.bs_Fields.Add('V.ECF_VINCULO_ID;#;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Distinct := True;
    CaixaTexto.bs_Join := ' Inner Join ECF_CONTA C on C.GRUPO = V.GRUPO ' +
                          ' Inner Join ECF_CENTRO_CUSTO CC on CC.ECF_CENTRO_CUSTO_ID = V.ECF_CENTRO_CUSTO_ID ' +
                          ' Inner Join ECF_CENTRO_CUSTO C2 on C2.ECF_CENTRO_CUSTO_ID = V.ECF_CENTRO_CUSTO_FILHO ';


    CaixaTexto.bs_TextResult := 'ECF_VINCULO_ID';
    CaixaTexto.bs_KeyField   := 'ECF_VINCULO_ID';
  end
  else
  if TipoConsulta = TipoECFCentroCusto then
  begin
    CaixaTexto.bs_Caption := 'Centro de Custo';
    CaixaTexto.bs_Table := 'ECF_CENTRO_CUSTO CC With (NOLOCK)';

    CaixaTexto.bs_Fields.Add('CC.CENTRO_CUSTO;Centro de Custo;;' + inttostr(WIDTH_DOCUMENTO));                    //0
    CaixaTexto.bs_Fields.Add('CC.TITULO;Titulo;;' + inttostr(WIDTH_NOME220));
    CaixaTexto.bs_Fields.Add('CC.GRUPO;Grupo de Contas;;' + inttostr(WIDTH_DOCUMENTO));

    CaixaTexto.bs_Fields.Add('CC.ECF_CENTRO_CUSTO_ID;#;;' + inttostr(WIDTH_DOCUMENTO));


    CaixaTexto.bs_TextResult := 'CENTRO_CUSTO';
    CaixaTexto.bs_KeyField   := 'ECF_CENTRO_CUSTO_ID';
  end
  else

  if TipoConsulta = TipoECFConta then
  begin
    CaixaTexto.bs_Caption := 'CONTA';
    CaixaTexto.bs_Table := 'ECF_CONTA With (NOLOCK)';

    CaixaTexto.bs_Fields.Add('NUMERO_CONTA;Conta;;' + inttostr(WIDTH_DOCUMENTO));                    //0
    CaixaTexto.bs_Fields.Add('DESCRICAO;Descrição;;' + inttostr(WIDTH_NOME220));
    CaixaTexto.bs_Fields.Add('CODIGO_LINHA;Codigo da Linha;;' + inttostr(WIDTH_DOCUMENTO));
    CaixaTexto.bs_Fields.Add('GRUPO;Grupo de Contas;;' + inttostr(WIDTH_DOCUMENTO));

    CaixaTexto.bs_Fields.Add('ECF_CONTA_ID;#;;' + inttostr(WIDTH_DOCUMENTO));


    CaixaTexto.bs_TextResult := 'GRUPO';
    CaixaTexto.bs_KeyField   := 'ECF_CONTA_ID';
  end
  else
