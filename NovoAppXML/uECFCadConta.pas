...
begin
   ...
   If ( Test_IsEmptyStr(EdiLinha.Text) ) Then
	 Begin
			 Mens_MensInf('É necessário informar o Código da Linha !') ;        //EdiApelido
			 EdiLinha.SetFocus ;
			 Exit ;
	 End ;
   ...
   If ( Test_IsEmptyStr(ediDescricao.Text) ) Then
	 Begin
			 Mens_MensInf('É necessário informar a Descrição !') ;        //EdiApelido
   ...
   begin
       ...
       begin
           Mens_MensInf('Número de Conta já cadastrada !') ;        //EdiApelido
           ediConta.SetFocus ;
           QryAux.Close;
           Exit ;
       end;
