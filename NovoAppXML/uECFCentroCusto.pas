...
begin
   ...
   begin
   		 Mens_MensInf('Centro de Custo já cadastrado !') ;        //EdiApelido
   ...
   editTipoCusto.AsInteger := EditBuscaTipoCusto.bs_KeyValue;
...
procedure TFrmECFCentroCusto.Search;
begin
  inherited;
  EditBuscaTipoCusto.SetValue('TP_CENTRO_CUSTO_ID=' + QuotedStr(editTipoCusto.AsString));
end;
