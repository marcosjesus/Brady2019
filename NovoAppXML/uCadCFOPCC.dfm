inherited FrmCadCFOPCC: TFrmCadCFOPCC
  Caption = 'Cadastro de CFOP x Conta Cont'#225'bil'
  PixelsPerInch = 96
  TextHeight = 13
  inherited PanFundo: TPanel
    object Panel1: TPanel
      ...
      object EditBuscaCFOPCC: TEditBusca
        Left = 116
        Top = 2
        Width = 169
        Height = 22
        TabOrder = 1
        OnClick = EditBuscaCFOPCCClick
        ClickOnArrow = True
        ClickOnReturn = False
        bs_HeightForm = 0
        bs_WidthForm = 0
