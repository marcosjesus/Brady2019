...
type
  TfrmConsultaItens = class(TForm)
    ...
    Label7: TLabel;
    EditTotalNF: TrsSuperEdit;
    PageItemS: TcxPageControl;
    TabGradeS: TcxTabSheet;
    TabEditS: TcxTabSheet;
    Panel7: TPanel;
    Panel8: TPanel;
    Image1: TImage;
    Label8: TLabel;
    Edit1: TEdit;
    rsDBSuperEdit1: TrsDBSuperEdit;
    ...
    Panel15: TPanel;
    rsSuperEdit23: TrsSuperEdit;
    rsSuperEdit24: TrsSuperEdit;
    rsSuperEdit25: TrsSuperEdit;
    rsSuperEdit26: TrsSuperEdit;
    rsSuperEdit27: TrsSuperEdit;
    rsSuperEdit28: TrsSuperEdit;
    Panel16: TPanel;
    rsSuperEdit29: TrsSuperEdit;
    rsSuperEdit30: TrsSuperEdit;
    rsSuperEdit31: TrsSuperEdit;
    rsSuperEdit32: TrsSuperEdit;
    rsSuperEdit33: TrsSuperEdit;
    Panel17: TPanel;
    rsSuperEdit34: TrsSuperEdit;
    rsSuperEdit35: TrsSuperEdit;
    rsSuperEdit36: TrsSuperEdit;
    rsSuperEdit37: TrsSuperEdit;
    rsSuperEdit38: TrsSuperEdit;
    Panel19: TPanel;
    rsSuperEdit39: TrsSuperEdit;
    rsSuperEdit40: TrsSuperEdit;
    rsSuperEdit41: TrsSuperEdit;
    rsSuperEdit42: TrsSuperEdit;
    rsSuperEdit43: TrsSuperEdit;
    Panel20: TPanel;
    rsSuperEdit44: TrsSuperEdit;
    Edit4: TEdit;
    ...
    Label11: TLabel;
    Label12: TLabel;
    rsSuperEdit45: TrsSuperEdit;
    rsSuperEdit46: TrsSuperEdit;
    cxDateEdit1: TcxDateEdit;
    rsSuperEdit47: TrsSuperEdit;
    Panel21: TPanel;
    rsSuperEdit48: TrsSuperEdit;
    rsSuperEdit49: TrsSuperEdit;
    rsSuperEdit50: TrsSuperEdit;
    cxGrid1: TcxGrid;
...
begin
  ...
  begin
    ...
    if cdsConsultaNFES.IsEmpty then
      Application.MessageBox('Dados de NF-e não encontrados.', 'Consultar - NF-e', mb_iconinformation +  MB_OK);
...
begin
   ...
   Try
      ...
      begin
        ...
        Mens_MensInf('CFOP não encontrado.');
   Finally
     FreeAndNil(sqlCFOP);
   End;
end;
...
begin
  ...
  begin
    if cdsConsultaNFES.IsEmpty then
    begin
        Application.MessageBox('Não há dados de NF-e para serem exportados.', 'Exportar para Excel - NFe', mb_iconinformation +  MB_OK);
        Exit;
    end;
...
begin
  ...
  begin
     ...
     EditTotalNF.Value            := cdsConsultaNFEEvTPrest.AsFloat;
...
begin
  ...
  Page.ActivePage := TabNFES;
  PageItem.ActivePage := tbsGrade;
  PageItemS.ActivePage := TabGradeS;
