...
begin
  ...
  begin
    ...
    begin
      ...
      and (copy(c,x,1) <> '#') and (copy(c,x,1) <> '&') and (copy(c,x,1) <> '*') and (copy(c,x,1) <> 'º') then
...
retorno : String;
begin
 // a partir do tamanho da linha procura a posição inicial -2 (1 espaço em branco q inclui a + no for e 1 para inicio correto)
 for  x := tl to i-2 do
     retorno := retorno + ' ';
