...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_INSTRUTOR) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_TIPOTREINAMENTO) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_TREINAMENTO) não liberada para o usuário !') ;
       Exit;
   End ;
...
//   qryAux.SQL.Add('Select Convert(DateTime, (convert(varchar(10), getdate(), 103))) as DataServer ');
   ...
   stb.panels[0].Text := 'Usuário - ' + FrmLogin.EdiUsuario.Text;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_PERIODICIDADE) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (REL-PARTICIPANTE) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (REL-TREINAMENTO) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
  ...
  Begin
      Mens_MensInf('Operação ( IMPORTAR_FUN ) não liberada para o usuário !') ;
      Exit;
  End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_PARTICIPANTE) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_CARGO) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
  If ( Not Glob_GetAccess('CAD_CENTROCUSTO','') ) Then
   Begin
       Mens_MensInf('Operação (CAD_CENTROCUSTO) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
   ...
   Begin
       Mens_MensInf('Operação (CAD_CURSO) não liberada para o usuário !') ;
       Exit;
   End ;
...
begin
{
  ...
  begin
   ...
   begin
      Mens_MensInf('Por favor, Fechar a Tela de Emissão de Nota Fiscal Para Continuar ! ');
      MDIChildren[ i ].Show;
      Exit;
   end;
  end;
