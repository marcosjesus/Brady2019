...
procedure TFrmEditaItem.FormCreate(Sender: TObject);
begin

  LabCadTit.Caption := 'Item da Nota Fiscal' ;
  FormOperacao  := 'CONS_DOCUMENTO' ;
  FormTabela    := 'CTE_ITENS' ;
  FormChaves    := 'NUMNF;ChaveSeq';
  FormCtrlFocus := 'EdiCFOP' ;
  FormDataFocus := 'EditDescProduto' ;
