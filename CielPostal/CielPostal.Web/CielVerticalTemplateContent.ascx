<%@ Control Language="C#" CodeBehind="CielVerticalTemplateContent.ascx.cs" ClassName="CielVerticalTemplateContent"
    CompilationMode="Auto" Inherits="CielPostal.Web.CielVerticalTemplateContent" AutoEventWireup="True" %>
                                ...
                                <tr>
                                    <td class="Logo">
                                        <asp:HyperLink runat="server" NavigateUrl="#" ID="LogoLink">
                                            ...
                                            <cc4:ThemedImageControl ID="TIC" DefaultThemeImageLocation="~/" ImageName="CustomLogo.png" 
