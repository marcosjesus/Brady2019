object Fr_RelatorioManutencaoClientes: TFr_RelatorioManutencaoClientes
  Left = 0
  Top = 0
  Caption = 'Relat'#243'rio de Manuten'#231#227'o e Recupera'#231#227'o de Clientes'
  ClientHeight = 498
  ClientWidth = 1048
  Color = clBtnFace
  ...
  object Page: TcxPageControl
    ...
    ParentFont = False
    TabOrder = 1
    Properties.ActivePage = tabBaseClientes
    Properties.CustomButtons.Buttons = <>
    OnChange = PageChange
    ...
    ClientRectTop = 24
    object tabBaseClientes: TcxTabSheet
      Caption = 'Base Clientes'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object tabDetalhe: TcxTabSheet
      ...
      object Panel1: TPanel
        ...
        object cxLookupComboBoxPeriodo: TcxLookupComboBox
          ...
          Properties.ListSource = DSFDQueryPeriodo
          TabOrder = 0
          Width = 171
        end
        ...
        object cxButtonPathPeriodo: TcxButtonEdit
          Left = 6
          Top = 25
          Properties.Buttons = <
            item
          ...
          Properties.ReadOnly = True
          TabOrder = 2
          OnClick = cxButtonPathPeriodoClick
          Width = 171
        end
      end
    end
    ...
    object cxTabSheet2: TcxTabSheet
      ...
      object cxDBPivotGrid00: TcxDBPivotGrid
        ...
        object cxDBPivotGrid00FieldVALOR: TcxDBPivotGridField
          Area = faData
          AreaIndex = 0
        ...
        object cxDBPivotGrid00FieldDATA: TcxDBPivotGridField
          Area = faColumn
          AreaIndex = 0
        ...
        object cxDBPivotGrid00FieldStatus: TcxDBPivotGridField
          AreaIndex = 0
          DataBinding.FieldName = 'STATUS'
          Visible = True
          UniqueName = 'STATUS'
        end
        object cxDBPivotGrid00FieldRecencia: TcxDBPivotGridField
          AreaIndex = 1
          DataBinding.FieldName = 'RECENCIA'
          Visible = True
          UniqueName = 'RECENCIA'
        end
        object cxDBPivotGrid00FieldClassificacao: TcxDBPivotGridField
          AreaIndex = 2
  ...
  object FDQueryBase: TFDQuery
    ...
    SQL.Strings = (
      ...
      'SELECT  '
        ...
        'TSOP_ORDBILCLICOD,TSOP_ORDBILREPNOM,TSOP_ORDBILGRUCLINOM,TSOP_OR' +
        'DBILCLINOM,TSOP_ORDBILSITNOM,TSOP_ORDBILCANNOM,TSOP_ORDBILREG,TS' +
        'OP_ORDBILREGEST,    '
      
        '[Aug 2019],[Sep 2019],[Oct 2019],[nov 2019],[Dec 2019],[jan 2020' +
        '],[Feb 2020],[mar 2020],[Apr 2020],[May 2020],[jun 2020],[jul 20' +
        '20]'
      'FROM  '
      '( '
      #9'SELECT '
      
        #9#9' CASE when B01.TSOP_ORDBILREPNOM = '#39'ALESSANDRA GO'#199'ALO'#39' THEN '#39#39 +
        ' ELSE B01.TSOP_ORDBILGRUCLINOM END AS TSOP_ORDBILGRUCLINOM'#9',C01.' +
        'TSOP_ORDBILCLICOD,B01.TSOP_ORDBILCANNOM ,B01.TSOP_ORDBILSITNOM ,' +
        'B01.TSOP_ORDBILREPNOM,B01.TSOP_ORDBILCLINOM  '
      #9#9',TSOP_ORDBILTYP = CAST('#39'BILLING'#39' AS VARCHAR(255))'
      
        #9#9',CONVERT(CHAR(4), C01.TSOP_ORDBILDATDOC, 100) + CONVERT(CHAR(4' +
        '), C01.TSOP_ORDBILDATDOC, 120) AS MES '
      
        #9#9',TSOP_ORDBILVALLIQ = CAST(SUM(ISNULL(C01.TSOP_ORDBILVALLIQ,0.0' +
        '0)) AS NUMERIC(15,02)) '
      
        #9'  ,COALESCE( C01.TSOP_ORDBILREG,'#9'  B01.TSOP_ORDBILREG ) AS'#9#9'TSO' +
        'P_ORDBILREG   '
      
        #9'  ,COALESCE( C01.TSOP_ORDBILREGEST,'#9'  B01.TSOP_ORDBILREGEST ) A' +
        'S'#9'TSOP_ORDBILREGEST   '
      
        #9'FROM DBO.VSOP_MONTHS A01 WITH (NOLOCK)  CROSS JOIN VSOP_Cliente' +
        'BySalesRepForecast B01 WITH (NOLOCK) '
        ...
        #9'    '#9'      LEFT OUTER JOIN TSIS_USUARIO U ON UPPER(U.TSIS_USUNO' +
        'M) = UPPER(B01.TSOP_ORDBILREPNOM) '
      #9#9'WHERE  U.TSIS_USUATI = '#39'S'#39' '
      #9'AND C01.TSOP_ORDBILDATDOC >= :MES_INI '
      #9'AND C01.TSOP_ORDBILDATDOC <= :MES_FIM  '
      ' '
      #9' AND      Upper(COALESCE( B01.TSOP_ORDBILCANNOM, '#39#39')) <> '#39'DM'#39' '
      #9'GROUP BY '
      ...
      #9#9',B01.TSOP_ORDBILCLINOM '
        ...
        #9#9',CONVERT(CHAR(4), C01.TSOP_ORDBILDATDOC, 100) + CONVERT(CHAR(4' +
        '), C01.TSOP_ORDBILDATDOC, 120)  '
      '   ,C01.TSOP_ORDBILREG  '
      '   ,C01.TSOP_ORDBILREGEST  '
      '   ,B01.TSOP_ORDBILREG  '
      '   ,B01.TSOP_ORDBILREGEST  '
      '   UNION   '
      ' '#9'SELECT DISTINCT '
      
        ' '#9#9' CASE when B01.TSOP_ORDBILREPNOM = '#39'ALESSANDRA GO'#199'ALO'#39' THEN '#39 +
        #39' ELSE B01.TSOP_ORDBILGRUCLINOM END AS TSOP_ORDBILGRUCLINOM ,C01' +
        '.TSOP_ORDBILCLICOD,B01.TSOP_ORDBILCANNOM'#9',B01.TSOP_ORDBILSITNOM,' +
        ' B01.TSOP_ORDBILREPNOM, B01.TSOP_ORDBILCLINOM   '
      
        ' '#9#9',TSOP_ORDBILTYP = CAST('#39'BILLING'#39' AS VARCHAR(255)) ,'#39'0'#39' AS MES' +
        ',0 TSOP_ORDBILVALLIQ ,COALESCE( C01.TSOP_ORDBILREG,'#9'  B01.TSOP_O' +
        'RDBILREG ) AS'#9#9'TSOP_ORDBILREG ,COALESCE( C01.TSOP_ORDBILREGEST,'#9 +
        '  B01.TSOP_ORDBILREGEST ) AS'#9'TSOP_ORDBILREGEST  '
      ' '#9'FROM  VSOP_ClienteBySalesRepForecast B01 WITH (NOLOCK)   '
      
        ' '#9#9#9#9#9#9#9'LEFT  JOIN VSOP_ORDERBILLINGFULL C01 WITH (NOLOCK)  ON (' +
        ' B01.TSOP_ORDBILCLICOD  = C01.TSOP_ORDBILCLICOD  '
      
        ' '#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND B01.TSOP_ORDBILCANNOM  = C01.TSOP_ORDBILCA' +
        'NNOM  '
      
        ' '#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND B01.TSOP_ORDBILSITNOM  = C01.TSOP_ORDBILSI' +
        'TNOM    '
      
        ' '#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND C01.TSOP_ORDBILTIPDOC  IN ('#39'BILLING'#39','#39'RETU' +
        'RN'#39') )  '
      
        '  '#9'LEFT OUTER JOIN TSIS_USUARIO U ON UPPER(U.TSIS_USUNOM) = UPPE' +
        'R(B01.TSOP_ORDBILREPNOM) '
      '  '#9'WHERE  U.TSIS_USUATI = '#39'S'#39' '
      
        '     AND  NOT EXISTS (SELECT TSOP_ORDBILCLICOD  FROM VSOP_ORDERB' +
        'ILLINGFULL D01 WITH(NOLOCK)   '
      
        ' '#9'                                         WHERE '#9' D01.TSOP_ORDB' +
        'ILTIPDOC  IN ('#39'BILLING'#39','#39'RETURN'#39')  '
      ' '#9#9#9#9#9#9#9#9#9#9#9#9#9'AND'#9'D01.TSOP_ORDBILDATDOC >= :MES_INI    '
      
        ' '#9'                        AND D01.TSOP_ORDBILDATDOC <= :MES_FIM ' +
        '   '
      
        ' '#9'                        AND D01.TSOP_ORDBILCLICOD = C01.TSOP_O' +
        'RDBILCLICOD  '
      
        ' '#9#9#9#9#9#9#9#9#9'  '#9#9#9'AND D01.TSOP_ORDBILCANNOM = C01.TSOP_ORDBILCANNOM' +
        '  '
      
        '                           AND D01.TSOP_ORDBILSITNOM = C01.TSOP_' +
        'ORDBILSITNOM )'
      ' '
      ...
      '   SUM(TSOP_ORDBILVALLIQ)  '
        ...
        '  FOR Mes IN ( [Aug 2019],[Sep 2019],[Oct 2019],[nov 2019],[Dec ' +
        '2019],[jan 2020],[Feb 2020],[mar 2020],[Apr 2020],[May 2020],[ju' +
        'n 2020],[jul 2020])'
      '  ) AS PIVOTTABLE  '
      ' )  '
      
        'SELECT B.TSOP_ORDBILREPNOM,B.TSOP_ORDBILGRUCLINOM, B.TSOP_ORDBIL' +
        'CLICOD,'
      
        '     B.TSOP_ORDBILCLINOM, B.TSOP_ORDBILSITNOM, B.TSOP_ORDBILCANN' +
        'OM, B.TSOP_ORDBILREG, B.TSOP_ORDBILREGEST, '
      
        '(IsNull(B.[Aug 2019],0) +IsNull(B.[Sep 2019],0) +IsNull(B.[Oct 2' +
        '019],0) +IsNull(B.[nov 2019],0) +IsNull(B.[Dec 2019],0) +IsNull(' +
        'B.[jan 2020],0) +IsNull(B.[Feb 2020],0) +IsNull(B.[mar 2020],0) ' +
        '+IsNull(B.[Apr 2020],0) +IsNull(B.[May 2020],0) +IsNull(B.[jun 2' +
        '020],0) +IsNull(B.[jul 2020],0) ) as Acumulado, '
      #39#39' AS Classificacao,'
      ' '#9' CASE WHEN  ( SELECT COUNT(*)  '
      
        '     FROM (VALUES (B.[Aug 2019]),(B.[Sep 2019]),(B.[Oct 2019]),(' +
        'B.[nov 2019]),(B.[Dec 2019]),(B.[jan 2020]),(B.[Feb 2020]),(B.[m' +
        'ar 2020]),(B.[Apr 2020]),(B.[May 2020]),(B.[jun 2020]),(B.[jul 2' +
        '020])) AS V(COL) WHERE V.COL IS NOT NULL ) > 0 THEN (IsNull(B.[A' +
        'ug 2019],0) +IsNull(B.[Sep 2019],0) +IsNull(B.[Oct 2019],0) +IsN' +
        'ull(B.[nov 2019],0) +IsNull(B.[Dec 2019],0) +IsNull(B.[jan 2020]' +
        ',0) +IsNull(B.[Feb 2020],0) +IsNull(B.[mar 2020],0) +IsNull(B.[A' +
        'pr 2020],0) +IsNull(B.[May 2020],0) +IsNull(B.[jun 2020],0) +IsN' +
        'ull(B.[jul 2020],0) )'
      
        ' /  ( SELECT COUNT(*)   FROM (VALUES  (B.[Aug 2019]),(B.[Sep 201' +
        '9]),(B.[Oct 2019]),(B.[nov 2019]),(B.[Dec 2019]),(B.[jan 2020]),' +
        '(B.[Feb 2020]),(B.[mar 2020]),(B.[Apr 2020]),(B.[May 2020]),(B.[' +
        'jun 2020]),(B.[jul 2020])) AS V(COL) WHERE V.COL IS NOT NULL ) E' +
        'LSE 0 END MEDIA, '
      
        ' CASE WHEN  ( SELECT COUNT(*) FROM (VALUES  (B.[Aug 2019]),(B.[S' +
        'ep 2019]),(B.[Oct 2019]),(B.[nov 2019]),(B.[Dec 2019]),(B.[jan 2' +
        '020]),(B.[Feb 2020]),(B.[mar 2020]),(B.[Apr 2020]),(B.[May 2020]' +
        '),(B.[jun 2020]),(B.[jul 2020])) AS V(COL) '
      
        '  WHERE V.COL IS NULL  ) <> 0 and  ( SELECT COUNT(*) FROM (VALUE' +
        'S  (B.[Aug 2019]),(B.[Sep 2019]),(B.[Oct 2019]),(B.[nov 2019]),(' +
        'B.[Dec 2019]),(B.[jan 2020]),(B.[Feb 2020]),(B.[mar 2020]),(B.[A' +
        'pr 2020]),(B.[May 2020]),(B.[jun 2020]),(B.[jul 2020])) AS V(COL' +
        ')  WHERE V.COL IS NULL  ) '
      ' % 3 = 0 THEN '#39'ATEN'#199#195'O'#39' ELSE '#39'OK'#39' END STATUS, '
      
        ' ( SELECT COUNT(*) FROM (VALUES (B.[Aug 2019]),(B.[Sep 2019]),(B' +
        '.[Oct 2019]),(B.[nov 2019]),(B.[Dec 2019]),(B.[jan 2020]),(B.[Fe' +
        'b 2020]),(B.[mar 2020]),(B.[Apr 2020]),(B.[May 2020]),(B.[jun 20' +
        '20]),(B.[jul 2020]))  AS V(COL) WHERE V.COL IS NOT NULL  ) AS HI' +
        'TS, '
      
        ' ( SELECT COUNT(*) FROM (VALUES  (B.[Aug 2019]),(B.[Sep 2019]),(' +
        'B.[Oct 2019]),(B.[nov 2019]),(B.[Dec 2019]),(B.[jan 2020]),(B.[F' +
        'eb 2020]),(B.[mar 2020]),(B.[Apr 2020]),(B.[May 2020]),(B.[jun 2' +
        '020]),(B.[jul 2020])) AS V(COL) WHERE V.COL IS NULL  ) AS FREQUE' +
        'NCIA, '
      
        '(B.[Aug 2019]),(B.[Sep 2019]),(B.[Oct 2019]),(B.[nov 2019]),(B.[' +
        'Dec 2019]),(B.[jan 2020]),(B.[Feb 2020]),(B.[mar 2020]),(B.[Apr ' +
        '2020]),(B.[May 2020]),(B.[jun 2020]),(B.[jul 2020])'
      '  FROM BILLING B '
      '  ORDER BY 9 DESC ')
    Left = 44
    Top = 217
  ...
  object cdsGraficoDetalhe: TClientDataSet
    Aggregates = <>
    Params = <>
    AfterOpen = cdsGraficoDetalheAfterOpen
    Left = 420
    Top = 233
  end
  object dsGraficoDetalhe: TDataSource
    DataSet = cdsGraficoDetalhe
    Left = 532
    Top = 233
  end
  object FDQueryRecuperaCliente: TFDQuery
    Connection = FDConnection
    Left = 164
    Top = 241
  end
  object dsRecuperaCliente: TDataSource
    DataSet = FDQueryRecuperaCliente
    Left = 153
    Top = 313
  end
  ...
  object FDQueryRecuperaClienteMem: TClientDataSet
    Aggregates = <>
    FieldDefs = <>
    IndexDefs = <>
    Params = <>
  ...
  object FDQueryResumo1: TFDQuery
    Connection = FDConnection
    Left = 724
    Top = 160
  end
  object dsResumo1: TDataSource
    DataSet = FDQueryResumo1
    Left = 828
    Top = 160
  end
  object FDQueryResumo2: TFDQuery
    Connection = FDConnection
    Left = 732
    Top = 232
  end
  object dsResumo2: TDataSource
    DataSet = FDQueryResumo2
    Left = 812
    Top = 240
  end
  object FDQueryResumo3: TFDQuery
    Connection = FDConnection
    Left = 732
    Top = 304
  end
  object FDQueryClienteAtivo: TFDQuery
    Connection = FDConnection
    Left = 336
    Top = 352
  end
  ...
  object FDQueryPeriodo: TFDQuery
    Connection = FDConnection
    SQL.Strings = (
      'SET LANGUAGE BRAZILIAN'
      
        'SELECT DISTINCT  DATENAME(MONTH,DATAFINAL) + '#39' de '#39' + CONVERT(VA' +
        'RCHAR(04),DATEPART(YEAR,DATAFINAL)) AS PERIODO, DATAFINAL AS DAT' +
        'A'
      ' FROM TSOP_CLIENTE_ATIVO ORDER BY DATAFINAL  DESC'
      '')
    Left = 524
    Top = 309
    object FDQueryPeriodoPERIODO: TWideStringField
      FieldName = 'PERIODO'
      Origin = 'PERIODO'
      ReadOnly = True
      Size = 38
    end
    object FDQueryPeriodoDATA: TDateField
      FieldName = 'DATA'
      Origin = 'DATA'
    end
  end
  object DSFDQueryPeriodo: TDataSource
    DataSet = FDQueryPeriodo
    Left = 604
    Top = 333
  end
  object Relatorio: TfrxReport
    ...
    ReportOptions.CreateDate = 44153.425661678200000000
    ReportOptions.LastChange = 44160.476651192130000000
    ...
    Datasets = <
      item
        DataSet = frxClienteAtivo
        DataSetName = 'frxClienteAtivo'
      end>
    Variables = <
      item
        Name = ' SubTitulo'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object subTitulo: TfrxMemoView
          Left = 327.921460000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxClienteAtivo'
        RowCount = 0
        object frxClienteAtivoTSOP_ORDBILCLICOD: TfrxMemoView
          Align = baWidth
          Top = 2.559060000000000000
          Width = 162.519790000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'TSOP_ORDBILCLICOD'
          DataSet = frxClienteAtivo
          DataSetName = 'frxClienteAtivo'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxClienteAtivo."TSOP_ORDBILCLICOD"]')
          ParentFont = False
        end
        object frxClienteAtivoTSOP_ORDBILCLINOM: TfrxMemoView
          Align = baWidth
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxClienteAtivo."TSOP_ORDBILCLINOM"]')
          ParentFont = False
        end
      end
  ...
  object frxClienteAtivo: TfrxDBDataset
    UserName = 'frxClienteAtivo'
    CloseDataSource = False
    FieldAliases.Strings = (
      'TSOP_ORDBILCLICOD=TSOP_ORDBILCLICOD'
      'TSOP_ORDBILCLINOM=TSOP_ORDBILCLINOM'
      'TSOP_ORDBILCANNOM=TSOP_ORDBILCANNOM')
    DataSet = FDQueryRelClienteAtivo
    BCDToCurrency = False
    Left = 12
    Top = 453
  end
  object FDQueryRelClienteAtivo: TFDQuery
    Connection = FDConnection
    SQL.Strings = (
      
        ' SELECT DISTINCT A.TSOP_ORDBILCLICOD, B.TSOP_ORDBILCLINOM, B.TSO' +
        'P_ORDBILCANNOM  FROM TSOP_CLIENTE_ATIVO A'
      
        ' INNER JOIN VSOP_CLIENTEBYSALESREPFORECAST B ON B.TSOP_ORDBILCLI' +
        'COD = A.TSOP_ORDBILCLICOD'
      
        ' WHERE DATAFINAL = :DATAFINAL AND B.TSOP_ORDBILCANNOM <> '#39'DM'#39' OR' +
        'DER BY 2,1')
    Left = 812
    Top = 373
    ParamData = <
  ...
  object FDQueryVisaoDinamica: TFDQuery
    Connection = FDConnection
    SQL.Strings = (
      
        'SELECT TSOP_ORDBILCLICOD,TSOP_ORDBILREPNOM,TSOP_ORDBILGRUCLINOM,' +
        'TSOP_ORDBILCLINOM,TSOP_ORDBILSITNOM,TSOP_ORDBILCANNOM,TSOP_ORDBI' +
        'LREG,TSOP_ORDBILREGEST,  TSOP_REPCSR,'
      
        ' STATUS, HITS, RECENCIA, CLIENTENOVO, MEDIA_12, CLASSIFICACAO_12' +
        ', ACUMULADO_12, MEDIA, CLASSIFICACAO, ACUMULADO, '
      
        ' CASE MES WHEN '#39'NOV 2019'#39' THEN CAST('#39'11'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39'2' +
        '019'#39' AS DATE)'
      
        '          WHEN '#39'DEZ 2019'#39' THEN CAST('#39'12'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39'2' +
        '019'#39' AS DATE)'
      
        '          WHEN '#39'JAN 2020'#39' THEN  CAST('#39'01'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'FEV 2020'#39' THEN  CAST('#39'02'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'MAR 2020'#39' THEN  CAST('#39'03'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'ABR 2020'#39' THEN  CAST('#39'04'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'MAI 2020'#39' THEN  CAST('#39'05'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'JUN 2020'#39' THEN  CAST('#39'06'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'JUL 2020'#39' THEN  CAST('#39'07'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'AGO 2020'#39' THEN  CAST('#39'08'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'SET 2020'#39' THEN  CAST('#39'09'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      
        '          WHEN '#39'OUT 2020'#39' THEN  CAST('#39'10'#39' + '#39'/'#39' + '#39'01'#39' + '#39'/'#39' + '#39 +
        '2020'#39' AS DATE)'
      #9#9'  END DATA,'
      ''
      '[MES], [VALOR]'
      'FROM TSOP_RECUPERACLIENTE_ALUGACOM C'
      'UNPIVOT ('
      '    [VALOR] FOR [MES] IN ( '
      
        '    [NOV 2019],[DEZ 2019],[JAN 2020],[FEV 2020],[MAR 2020],[ABR ' +
        '2020],[MAI 2020],[JUN 2020],[JUL 2020],[AGO 2020],[SET 2020],[OU' +
        'T 2020]'
      '    )'
      ') AS U'
      
        'ORDER BY TSOP_ORDBILCLICOD,TSOP_ORDBILREPNOM,TSOP_ORDBILGRUCLINO' +
        'M, MES')
    Left = 276
    Top = 184
    object FDQueryVisaoDinamicaTSOP_ORDBILCLICOD: TStringField
      FieldName = 'TSOP_ORDBILCLICOD'
      Origin = 'TSOP_ORDBILCLICOD'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILREPNOM: TStringField
      FieldName = 'TSOP_ORDBILREPNOM'
      Origin = 'TSOP_ORDBILREPNOM'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILGRUCLINOM: TStringField
      FieldName = 'TSOP_ORDBILGRUCLINOM'
      Origin = 'TSOP_ORDBILGRUCLINOM'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILCLINOM: TStringField
      FieldName = 'TSOP_ORDBILCLINOM'
      Origin = 'TSOP_ORDBILCLINOM'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILSITNOM: TStringField
      FieldName = 'TSOP_ORDBILSITNOM'
      Origin = 'TSOP_ORDBILSITNOM'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILCANNOM: TStringField
      FieldName = 'TSOP_ORDBILCANNOM'
      Origin = 'TSOP_ORDBILCANNOM'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILREG: TStringField
      FieldName = 'TSOP_ORDBILREG'
      Origin = 'TSOP_ORDBILREG'
      Size = 19
    end
    object FDQueryVisaoDinamicaTSOP_ORDBILREGEST: TStringField
      FieldName = 'TSOP_ORDBILREGEST'
      Origin = 'TSOP_ORDBILREGEST'
      Size = 255
    end
    object FDQueryVisaoDinamicaTSOP_REPCSR: TStringField
      FieldName = 'TSOP_REPCSR'
      Origin = 'TSOP_REPCSR'
      Size = 255
    end
    object FDQueryVisaoDinamicaSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      Required = True
      Size = 7
    end
    object FDQueryVisaoDinamicaHITS: TIntegerField
      FieldName = 'HITS'
      Origin = 'HITS'
    end
    object FDQueryVisaoDinamicaRECENCIA: TIntegerField
      FieldName = 'RECENCIA'
      Origin = 'RECENCIA'
      Required = True
    end
    object FDQueryVisaoDinamicaCLIENTENOVO: TIntegerField
      FieldName = 'CLIENTENOVO'
      Origin = 'CLIENTENOVO'
      Required = True
    end
    object FDQueryVisaoDinamicaMEDIA_12: TFMTBCDField
      FieldName = 'MEDIA_12'
      Origin = 'MEDIA_12'
      Required = True
      Precision = 14
    ...
    object FDQueryVisaoDinamicaCLASSIFICACAO_12: TStringField
      FieldName = 'CLASSIFICACAO_12'
      Origin = 'CLASSIFICACAO_12'
      Required = True
      Size = 1
    end
    object FDQueryVisaoDinamicaACUMULADO_12: TFMTBCDField
      FieldName = 'ACUMULADO_12'
      Origin = 'ACUMULADO_12'
      Required = True
      Precision = 14
      Size = 6
    end
    object FDQueryVisaoDinamicaMEDIA: TFMTBCDField
      FieldName = 'MEDIA'
      Origin = 'MEDIA'
      Precision = 38
      Size = 6
    end
    object FDQueryVisaoDinamicaCLASSIFICACAO: TStringField
      FieldName = 'CLASSIFICACAO'
      Origin = 'CLASSIFICACAO'
      Required = True
      Size = 1
    end
    object FDQueryVisaoDinamicaACUMULADO: TFMTBCDField
      FieldName = 'ACUMULADO'
      Origin = 'ACUMULADO'
      Precision = 38
      Size = 2
    end
    object FDQueryVisaoDinamicaMES: TWideStringField
      FieldName = 'MES'
      Origin = 'MES'
      ReadOnly = True
      Size = 128
    end
    object FDQueryVisaoDinamicaVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      ReadOnly = True
      Precision = 38
    ...
    object FDQueryVisaoDinamicaDATA: TDateField
      FieldName = 'DATA'
      Origin = 'DATA'
      ReadOnly = True
    end
  end
  object dsVisaoDinamica: TDataSource
    DataSet = FDQueryVisaoDinamica
    Left = 268
    Top = 240
  end
end
