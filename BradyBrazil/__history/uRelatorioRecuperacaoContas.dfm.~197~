object Fr_RelatorioRecuperacaoContas: TFr_RelatorioRecuperacaoContas
  Left = 0
  Top = 0
  Caption = 'S&OP - Relat'#243'rio - Recupera'#231#227'o de Clientes'
  ClientHeight = 746
  ClientWidth = 1366
  Color = clBtnFace
  ...
  object cxPageControl: TcxPageControl
    ...
    object cxTabSheet1: TcxTabSheet
      ...
      object cxGridContas: TcxGrid
        ...
        object cxGridContasDBTableContas: TcxGridDBTableView
          ...
          DataController.Summary.DefaultGroupSummaryItems = <
            item
              Format = 'R$ #,#00.00'
              Kind = skSum
              Column = cxGridContasDBTableContasTSOP_ORDBILVALLIQ
              Sorted = True
            end
            item
              Format = 'Qtde #,##0'
              Kind = skSum
              Column = cxGridContasDBTableContasTSOP_ORDBILQTD
            end
            item
              Format = 'Linhas #,##0'
              Kind = skCount
              Column = cxGridContasDBTableContasTSOP_ORDBILITECOD
            end
            item
              Position = spFooter
              Column = cxGridContasDBTableContasTSOP_ORDBILVALLIQ
          ...
          object cxGridContasDBTableContasTSOP_ORDBILCLICOD: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILCLICOD'
            PropertiesClassName = 'TcxHyperLinkEditProperties'
            Visible = False
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_CLISAPCLINOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_CLISAPCLINOM'
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_SUSPEXCLUIDO: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_SUSPEXCLUIDO'
          ...
          object cxGridContasDBTableContasTSOP_DTASUSPENSO: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_DTASUSPENSO'
            Visible = False
          end
          object cxGridContasDBTableContasTSOP_MOTIVOEXCLUSAO: TcxGridDBColumn
            Caption = 'Status'
            DataBinding.FieldName = 'TSOP_MOTIVOEXCLUSAO'
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORINOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORINOM'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILSITNOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILSITNOM'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILCANNOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILCANNOM'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILYEADOCCAL: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILYEADOCCAL'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILMONDOCCAL: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILMONDOCCAL'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILYEADOC: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILYEADOC'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILMONDOC: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILMONDOC'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILGRUCLINOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILGRUCLINOM'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILTIPDOC: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILTIPDOC'
            Visible = False
            Width = 150
          end
          object cxGridContasDBTableContasNRODIAS: TcxGridDBColumn
            Caption = 'Nr. Dias'
            DataBinding.FieldName = 'NRODIAS'
            Visible = False
          end
          object cxGridContasDBTableContasTSOP_ORDBILDATDOC: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILDATDOC'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILDATDOCREQ: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILDATDOCREQ'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILNRODOC: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILNRODOC'
            Visible = False
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILNRODOCREF: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILNRODOCREF'
            Visible = False
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILQTD: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILQTD'
            Visible = False
          end
          object cxGridContasDBTableContasTSOP_ORDBILVALLIQ: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILVALLIQ'
            Visible = False
            Width = 120
          end
          object cxGridContasDBTableContasTSOP_ORDBILITECOD: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITECOD'
            Visible = False
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILYEADOCREQCAL: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILYEADOCREQCAL'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILMONDOCREQCAL: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILMONDOCREQCAL'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILYEADOCREQ: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILYEADOCREQ'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_ORDBILMONDOCREQ: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILMONDOCREQ'
            Visible = False
            Width = 130
          end
          object cxGridContasDBTableContasTSOP_GRUCLIMER: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_GRUCLIMER'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILREPNOM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILREPNOM'
            Visible = False
            Width = 150
          end
          object cxGridContasDBTableContasTSOP_REPNOMINT: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_REPNOMINT'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_REPMKT: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_REPMKT'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_REPCSR: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_REPCSR'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM001: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM001'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM002: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM002'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM003: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM003'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM004: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM004'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAM005: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAM005'
            Visible = False
            Width = 200
          end
          object cxGridContasDBTableContasTSOP_REPACCTYP: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_REPACCTYP'
            Width = 120
          end
          object cxGridContasDBTableContasTSOP_ORDBILREGEST: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILREGEST'
            Width = 73
          end
          object cxGridContasDBTableContasTSOP_ORDBILREG: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILREG'
            Width = 100
          end
          object cxGridContasDBTableContasTSOP_ORDBILITEFAMPAI: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_ORDBILITEFAMPAI'
            Width = 150
          end
          object cxGridContasDBTableContasTSOP_PRIMARYCATALOG: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_PRIMARYCATALOG'
            VisibleForCustomization = False
            Width = 120
          end
          object cxGridContasDBTableContasTSOP_CUSTOMERPURCHASE: TcxGridDBColumn
            DataBinding.FieldName = 'TSOP_CUSTOMERPURCHASE'
            VisibleForCustomization = False
            Width = 120
          end
          object cxGridContasDBTableContasTSOP_LINKSALESFORCE: TcxGridDBColumn
        ...
        object cxGridLevelTableContas: TcxGridLevel
          Caption = '00 - Customizado'
          GridView = cxGridContasDBTableContas
        end
      end
    end
  end
  ...
  object FDQueryVSOP_OrderBilling00: TFDQuery
    BeforePost = FDQueryVSOP_OrderBilling00BeforePost
    CachedUpdates = True
    Connection = FDConnection
    SQL.Strings = (
      'SELECT  P.TSOP_ORDBILCOD, '
      '             P.TSOP_ORDBILCANNOM, '
      #9#9#9' P.TSOP_ORDBILCLICOD '
      #9#9#9',P.TSOP_ORDBILREPNOM'
      #9#9#9',P.TSOP_ORDBILGRUCLINOM'
      #9#9#9',R01.TSOP_CLISAPCLINOM  '
      #9#9#9',P.TSOP_PRIMARYCATALOG '
      #9#9#9',P.TSOP_ORDBILITECOD '
      #9#9#9',P.TSOP_ITECLISAPITECLICOD'
      #9#9#9',P.TSOP_ORDBILDATDOC'
      #9#9#9',P.TSOP_SUSPEXCLUIDO'
      #9#9#9',P.TSOP_DTASUSPENSO'
      #9#9#9',P.TSOP_MOTIVOEXCLUSAO'
      #9#9#9',P.TSOP_ORINOM '
      #9#9#9',P.TSOP_ORDBILSITNOM'
      #9#9#9',P.TSOP_ORDBILYEADOCCAL'
      #9#9#9',P.TSOP_ORDBILMONDOCCAL'
      #9#9#9',P.TSOP_ORDBILYEADOC'
      #9#9#9',P.TSOP_ORDBILMONDOC'
      #9#9#9',P.TSOP_ORDBILNRODOC'
      #9#9#9',P.TSOP_ORDBILTIPDOC'
      #9#9#9',P.TSOP_ORDBILNRODOCREF'
      #9#9#9',P.TSOP_ORDBILYEADOCREQCAL'
      #9#9#9',P.TSOP_ORDBILMONDOCREQCAL'
      #9#9#9',P.TSOP_ORDBILYEADOCREQ'
      #9#9#9',P.TSOP_ORDBILMONDOCREQ'
      #9#9#9',P.TSOP_ORDBILDATDOCREQ'
      #9#9#9',P.TSOP_GRUCLIMER'
      #9#9#9',P.TSOP_REPNOMINT'
      #9#9#9',P.TSOP_REPCSR'
      #9#9#9',P.TSOP_REPMKT'
      #9#9#9',P.TSOP_ORDBILITENOM'
      #9#9#9',P.TSOP_ORDBILITEUNI'
      #9#9#9',P.TSOP_ORDBILITEFAM'
      #9#9#9',P.TSOP_ORDBILITEFAMPAI'
      #9#9#9',P.TSOP_ORDBILITEFAM001'
      #9#9#9',P.TSOP_ORDBILITEFAM002'
      #9#9#9',P.TSOP_ORDBILITEFAM003'
      #9#9#9',P.TSOP_ORDBILITEFAM004'
      #9#9#9',P.TSOP_ORDBILITEFAM005'
      #9#9#9',P.TSOP_ORDBILVALLIQ'
      #9#9#9',P.TSOP_ORDBILQTD'
      #9#9#9',P.TSOP_REPACCTYP'
      #9#9#9',COALESCE(R01.TSOP_CLISAPCLIREG,'#39#39') AS TSOP_ORDBILREGEST'
      #9#9#9',COALESCE(R01.TSOP_CLISAPCLIREG,'#39#39')  AS TSOP_ORDBILREG'
      #9#9#9',P.TSOP_CUSTOMERPURCHASE'
      #9#9#9',P.TSOP_LINKSALESFORCE  AS TSOP_LINKSALESFORCE'
      #9#9#9',DATEDIFF(DAY,P.TSOP_ORDBILDATDOC, GETDATE()) NRODIAS'
      ''
      'FROM  DBO.TSOP_CLIENTESAP  R01  WITH (NOLOCK) '
      'CROSS APPLY'
      '('
      ''
      
        #9'SELECT TOP 1 B.TSOP_ORDBILCOD, B.TSOP_ORDBILCANNOM, B.TSOP_ORDB' +
        'ILCLICOD '
      #9#9#9',B.TSOP_ORDBILREPNOM'
      #9#9#9',B.TSOP_ORDBILGRUCLINOM'
      #9#9#9',B.TSOP_PRIMARYCATALOG '
      #9#9#9',B.TSOP_ORDBILITECOD '
      
        #9#9#9',CASE WHEN B.TSOP_ORDBILCANNOM = '#39'PID'#39' THEN B.TSOP_ITECLISAPI' +
        'TECLICOD ELSE COALESCE( B.TSOP_ORDBILITEFAMPAI, '#39#39' ) END AS TSOP' +
        '_ITECLISAPITECLICOD'
      #9#9#9',DATEDIFF(DAY, B.TSOP_ORDBILDATDOC, GETDATE()) NRODIAS'
      #9#9#9',B.TSOP_ORDBILDATDOC'
      #9#9#9',B.TSOP_SUSPEXCLUIDO'
      #9#9#9',B.TSOP_DTASUSPENSO'
      #9#9#9',B.TSOP_MOTIVOEXCLUSAO'
      #9#9#9',b.TSOP_ORINOM '
      #9#9#9',B.TSOP_ORDBILSITNOM'
      #9#9#9',b.TSOP_ORDBILYEADOCCAL'
      #9#9#9',b.TSOP_ORDBILMONDOCCAL'
      #9#9#9',b.TSOP_ORDBILYEADOC'
      #9#9#9',b.TSOP_ORDBILMONDOC'
      #9#9#9',B.TSOP_ORDBILNRODOC'
      #9#9#9',B.TSOP_ORDBILTIPDOC'
      #9#9#9',B.TSOP_ORDBILNRODOCREF'
      #9#9#9',b.TSOP_ORDBILYEADOCREQCAL'
      #9#9#9',b.TSOP_ORDBILMONDOCREQCAL'
      #9#9#9',b.TSOP_ORDBILYEADOCREQ'
      #9#9#9',b.TSOP_ORDBILMONDOCREQ'
      #9#9#9',B.TSOP_ORDBILDATDOCREQ'
      #9#9#9',b.TSOP_GRUCLIMER'
      #9#9#9',b.TSOP_REPNOMINT'
      #9#9#9',b.TSOP_REPCSR'
      #9#9#9',b.TSOP_REPMKT'
      #9#9#9',B.TSOP_ORDBILITENOM'
      #9#9#9',B.TSOP_ORDBILITEUNI'
      #9#9#9',b.TSOP_ORDBILITEFAM'
      #9#9#9',b.TSOP_ORDBILITEFAMPAI'
      #9#9#9',B.TSOP_ORDBILITEFAM001'
      #9#9#9',B.TSOP_ORDBILITEFAM002'
      #9#9#9',B.TSOP_ORDBILITEFAM003'
      #9#9#9',B.TSOP_ORDBILITEFAM004'
      #9#9#9',B.TSOP_ORDBILITEFAM005'
      #9#9#9',B.TSOP_ORDBILVALLIQ'
      #9#9#9',B.TSOP_ORDBILQTD'
      #9#9#9',b.TSOP_REPACCTYP  AS TSOP_REPACCTYP'
      #9#9#9',B.TSOP_CUSTOMERPURCHASE'
      #9#9#9',b.TSOP_LINKSALESFORCE  AS TSOP_LINKSALESFORCE'
      #9#9#9'FROM dbo.VSOP_OrderBillingFull B  WITH (NOLOCK) '
      ''
      #9#9#9'WHERE B.TSOP_ORDBILTIPDOC = '#39'BILLING'#39
      #9#9#9'AND B.TSOP_ORDBILCLICOD = R01.TSOP_CLISAPCLICOD'
      '                       '
      '                        &WHERE'
      ''
      '                        &WHERE1'
      ''
      #9#9#9'ORDER BY'
      #9#9#9#9'B.TSOP_ORDBILDATDOC DESC'
      ''
      ''
      ') P'
      'WHERE'
      '    P.TSOP_ORDBILDATDOC <= DATEADD(DAY, -:MESES, GETDATE()) '
      '    AND ISNULL(P.TSOP_SUSPEXCLUIDO,0) <> 2'
      'AND  NOT EXISTS (SELECT TSOP_ORDBILCOD '
      '  '#9#9#9#9'FROM TSOP_ORDERBILLING X'
      
        #9#9#9#9'WHERE  X.TSOP_ORDBILTIPDOC = '#39'BILLING'#39' and  P.TSOP_DTASUSPEN' +
        'SO >= DATEADD(DAY,-91,GETDATE())'
      #9#9#9#9'AND X.TSOP_ORDBILCLICOD = P.TSOP_ORDBILCLICOD )'
      '               ')
    Left = 200
    Top = 322
    ParamData = <
    ...
    object FDQueryVSOP_OrderBilling00TSOP_ORDBILCOD: TFDAutoIncField
    ...
    object FDQueryVSOP_OrderBilling00TSOP_CLISAPCLINOM: TStringField
    ...
    object FDQueryVSOP_OrderBilling00TSOP_SUSPEXCLUIDO: TIntegerField
      DisplayLabel = 'Exclu'#237'do'
      FieldName = 'TSOP_SUSPEXCLUIDO'
      Origin = 'TSOP_SUSPEXCLUIDO'
    end
    object FDQueryVSOP_OrderBilling00TSOP_DTASUSPENSO: TSQLTimeStampField
      DisplayLabel = 'Data Suspenso'
      FieldName = 'TSOP_DTASUSPENSO'
      Origin = 'TSOP_DTASUSPENSO'
    end
    object FDQueryVSOP_OrderBilling00TSOP_MOTIVOEXCLUSAO: TStringField
      DisplayLabel = 'Motivo'
    ...
    object FDQueryVSOP_OrderBilling00NRODIAS: TIntegerField
      FieldName = 'NRODIAS'
      Origin = 'NRODIAS'
      ReadOnly = True
    end
  ...
  object FDQueryAux: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DATEDIFF(DAY, MIN(TSOP_ORDBILDATDOC), GETDATE()) as MES F' +
        'ROM TSOP_ORDERBILLING WHERE TSOP_ORDBILDATDOC <> '#39'1899-12-30'#39)
    Left = 377
    Top = 314
    object FDQueryAuxMES: TIntegerField
      FieldName = 'MES'
      Origin = 'MES'
      ReadOnly = True
    end
