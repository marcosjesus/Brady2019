object frmExibeForecast: TfrmExibeForecast
  Left = 0
  Top = 0
  Caption = 'Forecast'
  ClientHeight = 528
          ...
          object ScrollBox: TScrollBox
            ...
            object cxGridDet: TcxGrid
              ...
              object cxGridDetDBTableView1: TcxGridDBTableView
                ...
                OptionsData.Inserting = False
                OptionsView.Indicator = True
                object cxGridDetDBTableView1TSOP_BUDCOD: TcxGridDBColumn
                  Caption = 'ID'
                  DataBinding.FieldName = 'TSOP_BUDCOD'
                  Width = 70
                end
                object cxGridDetDBTableView1TSOP_BUDTIP: TcxGridDBColumn
                  Caption = 'Tipo'
                  DataBinding.FieldName = 'TSOP_BUDTIP'
                end
                object cxGridDetDBTableView1TSOP_BUDDATREF: TcxGridDBColumn
                  Caption = 'Data Referencia'
                  DataBinding.FieldName = 'TSOP_BUDDATREF'
                  Width = 100
                end
                object cxGridDetDBTableView1TSOP_BUDDAT: TcxGridDBColumn
                  Caption = 'Data Forecast'
                  DataBinding.FieldName = 'TSOP_BUDDAT'
                  Width = 100
                end
                object cxGridDetDBTableView1TSOP_BUDCLICOD: TcxGridDBColumn
                  Caption = 'Cod. Cliente'
                  DataBinding.FieldName = 'TSOP_BUDCLICOD'
                  Width = 100
                end
                object cxGridDetDBTableView1TSOP_BUDVLF: TcxGridDBColumn
                  Caption = 'Valor'
                  DataBinding.FieldName = 'TSOP_BUDVLF'
                  Width = 100
                end
                object cxGridDetDBTableView1TSOP_BUDFAM: TcxGridDBColumn
                  Caption = 'Fam'#237'lia'
                  DataBinding.FieldName = 'TSOP_BUDFAM'
                  Width = 120
                end
                object cxGridDetDBTableView1TSOP_ORDBILSITNOM: TcxGridDBColumn
                  Caption = 'Site'
                  DataBinding.FieldName = 'TSOP_ORDBILSITNOM'
                  Width = 100
                end
                object cxGridDetDBTableView1TSOP_USUCOD: TcxGridDBColumn
                  Caption = 'Usuario'
                  DataBinding.FieldName = 'TSOP_USUCOD'
                  Width = 70
                end
                object cxGridDetDBTableView1TSIS_USUNOM: TcxGridDBColumn
                  Caption = 'Nome Usu'#225'rio'
                  DataBinding.FieldName = 'TSIS_USUNOM'
                  Width = 200
                end
                object cxGridDetDBTableView1TSOP_BUDDATCAD: TcxGridDBColumn
                  Caption = 'Data de Cadastro'
                  DataBinding.FieldName = 'TSOP_BUDDATCAD'
                  Width = 120
                end
              end
