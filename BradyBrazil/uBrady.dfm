  ...
  object dxBarManager: TdxBarManager
    ...
    object dxBarManagerBarSIOPRelatorio: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'dxBarLargeButtonSIOPOnBoardClientes'
        end>
      OneOnRow = False
      Row = 0
      UseOwnFont = False
    ...
    object dxBarLargeButtonSIOPRecuperacaodeContas: TdxBarLargeButton
      Caption = 'Recupera'#231#227'o de Clientes'
      Category = 3
      Hint = 'Recupera'#231#227'o de Clientes'
      Visible = ivAlways
      LargeImageIndex = 7
    ...
    object dxBarLargeButtonSIOPRecuperacaodeClientes: TdxBarLargeButton
      Caption = 'Recupera'#231#227'o de Clientes (esconder)'
      Category = 3
      Enabled = False
      Hint = 'Recupera'#231#227'o de Clientes (esconder)'
      Visible = ivNever
      LargeImageIndex = 7
      OnClick = dxBarLargeButtonSIOPRecuperacaodeClientesClick
      HotImageIndex = 7
      SyncImageIndex = False
      ImageIndex = 7
    end
    ...
    object dxBarLargeButtonSIOPOnBoardClientes: TdxBarLargeButton
      Caption = 'OnBoard Clientes'
      Category = 3
      Hint = 'OnBoard Clientes'
      Visible = ivAlways
      LargeImageIndex = 7
      OnClick = dxBarLargeButtonSIOPOnBoardClientesClick
      HotImageIndex = 7
      SyncImageIndex = False
      ImageIndex = 7
    end
