object Fr_RelatorioRecuperacaoClientes: TFr_RelatorioRecuperacaoClientes
  Left = 0
  Top = 0
    ...
    object cxPageControl1: TcxPageControl
      ...
      object cxTabSheet1: TcxTabSheet
        ...
        object v: TcxGrid
          ...
          TabOrder = 1
          ExplicitWidth = 866
          object cxGridRecuperaClientesDBTableCliente: TcxGridDBTableView
            Navigator.Buttons.CustomButtons = <>
            DataController.DataSource = DSFDQueryRecuperacaoClientes
            ...
            object cxGridRecuperaClientesDBTableClienteTSOP_ORDBILCLICOD: TcxGridDBColumn
              Caption = 'C'#243'digo Cliente'
              DataBinding.FieldName = 'TSOP_ORDBILCLICOD'
              Width = 125
            end
            object cxGridRecuperaClientesDBTableClienteTSOP_ORDBILGRUCLINOM: TcxGridDBColumn
              Caption = 'Grupo'
              DataBinding.FieldName = 'TSOP_ORDBILGRUCLINOM'
              Width = 230
            end
            object cxGridRecuperaClientesDBTableClienteTSOP_ORDBILCANNOM: TcxGridDBColumn
              Caption = 'Canal'
              DataBinding.FieldName = 'TSOP_ORDBILCANNOM'
              Width = 100
            end
            object cxGridRecuperaClientesDBTableClienteTSOP_GRUCLIMER: TcxGridDBColumn
              Caption = 'Mercado'
              DataBinding.FieldName = 'TSOP_GRUCLIMER'
              Width = 138
            end
            object cxGridRecuperaClientesDBTableClienteTSOP_ORDBILREPNOM: TcxGridDBColumn
              Caption = 'Vendedor'
              DataBinding.FieldName = 'TSOP_ORDBILREPNOM'
              Width = 217
            end
            object cxGridRecuperaClientesDBTableClienteTSOP_ORDBILDATDOC: TcxGridDBColumn
              Caption = 'Data da Compra'
              DataBinding.FieldName = 'TSOP_ORDBILDATDOC'
              Width = 100
            end
            object cxGridRecuperaClientesDBTableClienteNRODIAS: TcxGridDBColumn
              Caption = 'Nr'#186' Dias'
          ...
          object vLevel1: TcxGridLevel
            GridView = cxGridRecuperaClientesDBTableCliente
          end
        end
  ...
  object FDQueryRecuperacaoClientes: TFDQuery
    ...
    SQL.Strings = (
      ...
      '    SELECT '
        ...
        '       A01.TSOP_ORDBILCLICOD , A01.TSOP_ORDBILGRUCLINOM, A01.TSO' +
        'P_GRUCLIMER, A01.TSOP_ORDBILREPNOM, A01.TSOP_ORDBILDATDOC,'
      '        A01.TSOP_ORDBILCANNOM,'
      
        '        ROW_NUMBER() OVER(PARTITION BY A01.TSOP_ORDBILCLICOD ORD' +
        'ER BY TSOP_ORDBILDATDOC DESC) RN'
      '    FROM TSOP_CLIENTESAP C01'
      
        '    INNER  JOIN DBO.VSOP_ORDERBILLINGFULL          A01 ON ( A01.' +
        'TSOP_ORDBILCLICOD                = C01.TSOP_CLISAPCLICOD   )'
      #9'WHERE A01.TSOP_ORDBILTIPDOC = '#39'BILLING'#39
      ''
      ')'
      ''
      ''
      'SELECT'
        ...
        '     TSOP_ORDBILCLICOD , TSOP_ORDBILGRUCLINOM, TSOP_GRUCLIMER, T' +
        'SOP_ORDBILREPNOM, TSOP_ORDBILDATDOC,TSOP_ORDBILCANNOM,'
      '    DATEDIFF(DAY, TSOP_ORDBILDATDOC, GETDATE()) NRODIAS'
      'FROM CTE_RN'
      'WHERE'
      '&WHERE'
      '    RN = 1 AND'
      '    TSOP_ORDBILDATDOC <= DATEADD(MONTH, -:MESES, GETDATE()) '
      '    &WHERE1'
      'ORDER BY '
      '    TSOP_ORDBILDATDOC DESC')
    Left = 224
    Top = 201
    ParamData = <
      item
    ...
    object FDQueryRecuperacaoClientesTSOP_ORDBILCLICOD: TStringField
      FieldName = 'TSOP_ORDBILCLICOD'
      Origin = 'TSOP_ORDBILCLICOD'
      Required = True
      Size = 255
    end
    object FDQueryRecuperacaoClientesTSOP_ORDBILGRUCLINOM: TStringField
      FieldName = 'TSOP_ORDBILGRUCLINOM'
      Origin = 'TSOP_ORDBILGRUCLINOM'
      Size = 255
    end
    object FDQueryRecuperacaoClientesTSOP_GRUCLIMER: TStringField
      FieldName = 'TSOP_GRUCLIMER'
      Origin = 'TSOP_GRUCLIMER'
      Size = 255
    end
    object FDQueryRecuperacaoClientesTSOP_ORDBILREPNOM: TStringField
      FieldName = 'TSOP_ORDBILREPNOM'
      Origin = 'TSOP_ORDBILREPNOM'
      Size = 255
    end
    object FDQueryRecuperacaoClientesTSOP_ORDBILDATDOC: TSQLTimeStampField
      FieldName = 'TSOP_ORDBILDATDOC'
      Origin = 'TSOP_ORDBILDATDOC'
      Required = True
    end
    object FDQueryRecuperacaoClientesNRODIAS: TIntegerField
      FieldName = 'NRODIAS'
      Origin = 'NRODIAS'
      ReadOnly = True
    end
    object FDQueryRecuperacaoClientesTSOP_ORDBILCANNOM: TStringField
      FieldName = 'TSOP_ORDBILCANNOM'
      Origin = 'TSOP_ORDBILCANNOM'
      Size = 255
    end
  end
  object DSFDQueryRecuperacaoClientes: TDataSource
    DataSet = FDQueryRecuperacaoClientes
    Left = 224
    Top = 273
  end
  ...
  object FDQueryAux: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DATEDIFF(MONTH, MIN(TSOP_ORDBILDATDOC), GETDATE()) as MES' +
        ' FROM TSOP_ORDERBILLING WHERE TSOP_ORDBILDATDOC <> '#39'1899-12-30'#39)
    Left = 377
    Top = 314
