...
uses
  ...
  FireDAC.Comp.Script, cxCurrencyEdit, cxMemo;

type
  TFr_RelatorioVendas = class(TForm)
...
var
  Fr_RelatorioVendas: TFr_RelatorioVendas;
...
procedure TFr_RelatorioVendas.AbrirDataset;
begin
...
procedure TFr_RelatorioVendas.Button1Click(Sender: TObject);
begin
...
procedure TFr_RelatorioVendas.cxDBPivotGrid02FieldTSOP_ORDBILVALLIQACCGetDisplayText(
  Sender: TcxPivotGridField; ACell: TcxPivotGridDataCellViewInfo;
  var AText: string);
var
  I: Integer;
...
procedure TFr_RelatorioVendas.cxDBPivotGrid03FieldTSOP_ORDBILVALLIQACCGetDisplayText(
  Sender: TcxPivotGridField; ACell: TcxPivotGridDataCellViewInfo;
  var AText: string);
var
  I: Integer;
...
procedure TFr_RelatorioVendas.FDQueryVSOP_OrderBillingForecastAccuracyCalcFields(
  DataSet: TDataSet);
begin
...
procedure TFr_RelatorioVendas.FDQueryVSOP_OrderBillingForecastAccuracyFamiliaCalcFields(
  DataSet: TDataSet);
begin
...
procedure TFr_RelatorioVendas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ...
  Fr_RelatorioVendas := nil;
  Action := caFree;

end;

procedure TFr_RelatorioVendas.FormContextPopup(Sender: TObject; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TFr_RelatorioVendas.FormCreate(Sender: TObject);
begin
...
function TFr_RelatorioVendas.getText(AText: String): String;
begin
...
procedure TFr_RelatorioVendas.LoadGridCustomization;
begin
...
procedure TFr_RelatorioVendas.Mensagem(pMensagem: String);
begin
