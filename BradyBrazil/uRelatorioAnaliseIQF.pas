...
begin
   ...
   try
    ...
    ABand.Caption := 'Informações de Fornecedores';
    ABand.FixedKind :=  fkLeft;

    ABand := cxGridIQFDBBandedTableView.Bands.Add;
    ABand.Index := 1;
    ABand.HeaderAlignmentHorz := taCenter;
    ABand.Caption := 'Período';
    ...
    AColumn := cxGridIQFDBBandedTableView.CreateColumn;
    AColumn.Width := 90;
    AColumn.Caption := 'Cód. Fornecedor';
...
begin
  ...
  AValueCaption := 'Mês:' + cxGridDBChartView1.DiagramPie.GetValueCaption(cxGridDBChartSeries1, AValueIndex);
...
begin
  ...
  AValueCaption := 'Mês:' + cxTableViewTMAQ_ApontamentoGrafico01.DiagramPie.GetValueCaption(cxTableViewTMAQ_ApontamentoGrafico01Series1, AValueIndex);
