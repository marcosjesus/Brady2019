unit uProcessamentoGrossMargin;
...
type
  TFr_ProcessamentoGrossMargin = class(TForm)
...
var
  Fr_ProcessamentoGrossMargin: TFr_ProcessamentoGrossMargin;
...
procedure TFr_ProcessamentoGrossMargin.AbrirDataset;
var
...
procedure TFr_ProcessamentoGrossMargin.ButExcelClick(Sender: TObject);
var
  // dxSpreadSheet: TdxSpreadSheet;
   I , X : Integer;
...
procedure TFr_ProcessamentoGrossMargin.CreatePlanilhaBOM;
var
   I , X : Integer;
   varCor1,varCor2: TColor;
begin
...
procedure TFr_ProcessamentoGrossMargin.CreatePlanilhaCosting;
var
   I , X : Integer;
   varCor1,varCor2: TColor;
begin
...
procedure TFr_ProcessamentoGrossMargin.CreatePlanilhaGrossMargin;
var
   I , X : Integer;
   varCor1,varCor2: TColor;
begin
...
procedure TFr_ProcessamentoGrossMargin.CreatePlanilhaRouting;
var
   I , X : Integer;
   varCor1,varCor2: TColor;
begin
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarClick(Sender: TObject);
begin
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarCUSTOClick(
  Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarITEMClick(
  Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarROUTINGClick(
  Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarUOMClick(Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaBOM2Click(Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaBOMClick(Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaCustoClick(Sender: TObject);
begin
  try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaItemClick(Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaMPRClick(Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaOrdemMPRClick(
  Sender: TObject);
begin
 try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaRoutingClick(
  Sender: TObject);
begin
  try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonAtualizaUOMClick(Sender: TObject);
begin
   try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonEditPathClick(Sender: TObject);
begin
...
procedure TFr_ProcessamentoGrossMargin.cxButtonInicioClick(Sender: TObject);
Var
...
procedure TFr_ProcessamentoGrossMargin.cxButtonInsertSQLClick(Sender: TObject);
begin
  try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarBOM1Click(Sender: TObject);
begin
 cxButtonProcessarBOM2.Enabled    := False;
 cxButtonProcessarBOM2.Enabled    := False;
 cxButtonProcessarITEM.Enabled    := False;
...
procedure TFr_ProcessamentoGrossMargin.cxButtonProcessarBOM2Click(
  Sender: TObject);
begin
 Try
...
procedure TFr_ProcessamentoGrossMargin.cxButtonRefreshClick(Sender: TObject);
begin
...
procedure TFr_ProcessamentoGrossMargin.cxButtonVerBom1Click(Sender: TObject);
begin
...
procedure TFr_ProcessamentoGrossMargin.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ...
  Fr_ProcessamentoGrossMargin := nil;
  Action := caFree;

end;

procedure TFr_ProcessamentoGrossMargin.FormContextPopup(Sender: TObject; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TFr_ProcessamentoGrossMargin.FormCreate(Sender: TObject);
var
  I: Integer;
...
procedure TFr_ProcessamentoGrossMargin.ImportarHoras;
var
  I, X: Integer;
  dxSpreadSheet: TdxSpreadSheet;
...
procedure TFr_ProcessamentoGrossMargin.LoadGridCustomization;
begin
...
procedure TFr_ProcessamentoGrossMargin.Mensagem(pMensagem: String);
begin
