...
type
  TFr_RelatorioRecuperacaoClientes = class(TForm)
    ...
    FDQueryRecuperacaoClientesTSOP_CLISAPCLINOM: TStringField;
    FDQueryRecuperacaoClientesTSOP_SUSPEXCLUIDO: TIntegerField;
    FDQueryRecuperacaoClientesTSOP_DTASUSPENSO: TSQLTimeStampField;
    FDQueryRecuperacaoClientesTSOP_MOTIVOEXCLUSAO: TStringField;
    FDQueryRecuperacaoClientesTSOP_ORINOM: TStringField;
    FDQueryRecuperacaoClientesTSOP_REPNOMINT: TStringField;
    FDQueryRecuperacaoClientesTSOP_REPCSR: TStringField;
    FDQueryRecuperacaoClientesTSOP_REPMKT: TStringField;
    FDQueryRecuperacaoClientesTSOP_REPACCTYP: TStringField;
    FDQueryRecuperacaoClientesTSOP_ORDBILREGEST: TStringField;
    FDQueryRecuperacaoClientesTSOP_ORDBILREG: TStringField;
    FDQueryRecuperacaoClientesTSOP_CUSTOMERPURCHASE: TStringField;
    FDQueryRecuperacaoClientesTSOP_LINKSALESFORCE: TStringField;
    cxGridRecuperaClientesDBTableClienteTSOP_CLISAPCLINOM: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_SUSPEXCLUIDO: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_DTASUSPENSO: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_MOTIVOEXCLUSAO: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_ORINOM: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_REPNOMINT: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_REPCSR: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_REPMKT: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_REPACCTYP: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_ORDBILREGEST: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_ORDBILREG: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_CUSTOMERPURCHASE: TcxGridDBColumn;
    cxGridRecuperaClientesDBTableClienteTSOP_LINKSALESFORCE: TcxGridDBColumn;
