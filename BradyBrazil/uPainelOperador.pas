...
begin
  ...
  begin
    ...
    ExibirMensagemErro( 'Tempo total maior que 60 minutos, informe a ultima operação novamente.' );
  ...
  begin
    ...
    begin
      ...
      ExibirMensagem( 'Informe número de horas para duplicar.' + varMsg, clWhite );
    ...
    begin
      ...
      ExibirMensagem( 'Informe o número de Metros / Folhas.' + varMsg, clWhite );
...
begin
  ...
  begin
    ...
    try
      ExibirMensagem( 'Executando sincronização BD.', clSkyBlue );
      try

        ExibirMensagem( 'Executando sincronização BD.'#13#10'Abrindo conexão.', clSkyBlue );
        FDConnection.Params.LoadFromFile( MyDocumentsPath + '\DB.ini' );
        FDConnection.Open;
        try

          ExibirMensagem( 'Executando sincronização BD.'#13#10'Atualizando Máquinas do Usuário.', clSkyBlue );
          FDQueryTSIS_UsuarioMaquina.ParamByName('TSIS_USULOG').AsString := ComputerName.Trim.ToUpper;
          FDQueryTSIS_UsuarioMaquina.Open;

          for I := 1 to 4 do
            FDadosConf.WriteString( 'Local', 'Máquina'+IntToStr(I), EmptyStr );

          I := 1;
          while not FDQueryTSIS_UsuarioMaquina.Eof do
          begin

            FDadosConf.WriteString( 'Local', 'Máquina'+IntToStr(I), FDQueryTSIS_UsuarioMaquinaTMAQ_MAQBAR.AsString );
            FDQueryTSIS_UsuarioMaquina.Next;
            Inc(I);

          end;

          ExibirMensagem( 'Executando sincronização BD.'#13#10'Atualizando lista de Máquinas.', clSkyBlue );
          FDBMaquina.Clear;
          ...
          ExibirMensagem( 'Executando sincronização BD.'#13#10'Atualizando lista de Operações.', clSkyBlue );
          FDBOperacao.Clear;
          ...
          ExibirMensagem( 'Executando sincronização BD.'#13#10'Atualizando lista de Operadores.', clSkyBlue );
          FDBOperador.Clear;
          ...
          ExibirMensagem( 'Executando sincronização BD.'#13#10'Atualizando Apontamentos.', clSkyBlue );
          varStringList := TStringList.Create;
          varStringListDeleted := TStringList.Create;
          try
      ...
      begin
        ...
        ExibirMensagemErro( 'Erro na sincronização BD.'#13#10 + E.Message );
...
begin
  ...
  begin
    ...
    begin
      ...
      ExibirMensagem( 'Informe número de horas para duplicar.' + #13#10 + CharRead + varMsg, clWhite );
    ...
    begin
      ...
      ExibirMensagem( 'Informe o número de Metros / Folhas.' + #13#10 + CharRead + varMsg, clWhite );
...
begin
  ...
  Result := RGB(FDadosConf.ReadInteger( 'Não Produtivo', 'Brush R', 0 ),
                FDadosConf.ReadInteger( 'Não Produtivo', 'Brush G', 0 ),
                FDadosConf.ReadInteger( 'Não Produtivo', 'Brush B', 0 ));
...
begin
  ...
  Result := RGB(FDadosConf.ReadInteger( 'Não Produtivo', 'Pen R', 0 ),
                FDadosConf.ReadInteger( 'Não Produtivo', 'Pen G', 0 ),
                FDadosConf.ReadInteger( 'Não Produtivo', 'Pen B', 0 ));
...
begin
  ...
  db_loadMaquinas;
  if not FDadosConf.ReadString( 'Local', 'Máquina'+IntToStr(Tag), EmptyStr ).IsEmpty then
    Maquina := FDadosConf.ReadString( 'Local', 'Máquina'+IntToStr(Tag), EmptyStr );
...
begin
  ...
  begin
    ...
    ExibirMensagemErro( 'Ação não permitida.' );
...
begin
  ...
  begin
    ...
    begin
      ...
      ExibirMensagemErro( 'Operador ainda não foi informado.' );
    ...
    begin
      ...
      try
        ...
        begin
          ...
          ExibirMensagemErro( 'Não existe hora disponivel para apontamento.' );
...
begin
  ...
  begin
    ...
    FAtividade := EmptyStr;
    ExibirMensagemErro( 'Atividade não permitida.' );
...
begin
  ...
  begin
    ...
    begin
      ...
      ExibirMensagemErro( 'Máquina não foi encontrada.' );
  ...
  begin
    ...
    ExibirMensagemErro( 'Máquina já foi informada. Não é possível alterar.' );
...
begin
  ...
  begin
    ...
    ExibirMensagemErro( 'Máquina ainda não foi informada.' );
...
begin
  ...
  Result := OnOperacao and OnMensagem and (Pos('Informe número de horas para duplicar.', LabelMensagem.Caption) > 0);
...
begin
  ...
  Result := OnOperacao and OnMensagem and (Pos('Informe o número de Metros / Folhas.', LabelMensagem.Caption) > 0);
