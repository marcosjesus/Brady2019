object Fr_Dados: TFr_Dados
  ...
  object FDQueryTSOP_OrderBilling: TFDQuery
    ...
    object FDQueryTSOP_OrderBillingTSOP_DTASUSPENSO: TSQLTimeStampField
      FieldName = 'TSOP_DTASUSPENSO'
      Origin = 'TSOP_DTASUSPENSO'
    end
    object FDQueryTSOP_OrderBillingTSOP_SUSPEXCLUIDO: TIntegerField
      FieldName = 'TSOP_SUSPEXCLUIDO'
      Origin = 'TSOP_SUSPEXCLUIDO'
    end
    object FDQueryTSOP_OrderBillingTSOP_MOTIVOEXCLUSAO: TStringField
      FieldName = 'TSOP_MOTIVOEXCLUSAO'
      Origin = 'TSOP_MOTIVOEXCLUSAO'
      Size = 50
    end
    object FDQueryTSOP_OrderBillingTSOP_SALESITEM: TIntegerField
  ...
  object FDQuerySalesRep: TFDQuery
    ...
    SQL.Strings = (
        ...
        '      ,TSIS_USUEML = COALESCE(A01.TSIS_USUEML,'#39'luciana_pontieri@' +
        'bradycorp.com'#39')'
      'FROM ('
  ...
  object FDQueryConsultaFamilia: TFDQuery
    Connection = FDConnection
    Left = 768
    Top = 312
  end
  object FDQueryTSOP_GMCustos_Original: TFDQuery
    CachedUpdates = True
    Connection = FDConnection
    SQL.Strings = (
      'SELECT * FROM TSOP_GMCUSTOS_ORIGINAL WHERE 1 = 1')
    Left = 208
    Top = 472
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCCOD: TFDAutoIncField
      FieldName = 'TSOP_GMCCOD'
      Origin = 'TSOP_GMCCOD'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCITE: TStringField
      FieldName = 'TSOP_GMCITE'
      Origin = 'TSOP_GMCITE'
      Required = True
    end
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCSIT: TStringField
      FieldName = 'TSOP_GMCSIT'
      Origin = 'TSOP_GMCSIT'
      Required = True
    end
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCLOT: TBCDField
      FieldName = 'TSOP_GMCLOT'
      Origin = 'TSOP_GMCLOT'
      Required = True
      Precision = 15
    ...
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCDAT: TSQLTimeStampField
      FieldName = 'TSOP_GMCDAT'
      Origin = 'TSOP_GMCDAT'
      Required = True
    end
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCCUSSTD: TBCDField
      FieldName = 'TSOP_GMCCUSSTD'
      Origin = 'TSOP_GMCCUSSTD'
      Required = True
      Precision = 15
    ...
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCCUSMOV: TBCDField
      FieldName = 'TSOP_GMCCUSMOV'
      Origin = 'TSOP_GMCCUSMOV'
      Required = True
      Precision = 15
    ...
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCPRIUNI: TBCDField
      FieldName = 'TSOP_GMCPRIUNI'
      Origin = 'TSOP_GMCPRIUNI'
      Required = True
      Precision = 15
    ...
    object FDQueryTSOP_GMCustos_OriginalTSOP_GMCBUD: TStringField
      FieldName = 'TSOP_GMCBUD'
      Origin = 'TSOP_GMCBUD'
      Size = 1
    end
    object FDQueryTSOP_GMCustos_OriginalTSOP_DT_IMPORTACAO: TDateField
      FieldName = 'TSOP_DT_IMPORTACAO'
