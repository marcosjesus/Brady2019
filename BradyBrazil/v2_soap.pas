...
// WSDL     : https://seton.com.br/index.php/api/v2_soap?wsdl=1
//  >Import : https://seton.com.br/index.php/api/v2_soap?wsdl=1>0
//  >Import : http://schemas.xmlsoap.org/soap/encoding/
// Encoding : UTF-8
// Version  : 1.0
// (15/01/2020 13:48:49 - - $Rev: 56641 $)
// ************************************************************************ //
...
type
  ...
  quoteEntity          = class;                 { "urn:Magento"[GblCplx] }
  c2qEntity            = class;                 { "urn:Magento"[GblCplx] }
  ...
  c2qEntityArray = array of c2qEntity;          { "urn:Magento"[GblCplx] }
  ...
  // ************************************************************************ //
  // XML       : quoteEntity, global, <complexType>
  // Namespace : urn:Magento
  // ************************************************************************ //
  quoteEntity = class(TRemotable)
  private
    Fproposal_sent: string;
    Fproposal_sent_Specified: boolean;
    Fstatus: string;
    Fstatus_Specified: boolean;
    Fsubstatus: string;
    Fsubstatus_Specified: boolean;
    Fsalesrule: string;
    Fsalesrule_Specified: boolean;
    Fcustomer_id: string;
    ...
    Fclient_request: string;
    Fclient_request_Specified: boolean;
    Finternal_comment: string;
    Finternal_comment_Specified: boolean;
    Fshipping_type: string;
    Fshipping_type_Specified: boolean;
    Fshipping_price: string;
    Fshipping_price_Specified: boolean;
    Fstore_id: string;
    ...
    Ffile_title: string;
    Ffile_title_Specified: boolean;
    Fpath: string;
    Fpath_Specified: boolean;
    Fshipping_prefix: string;
    Fshipping_prefix_Specified: boolean;
    Fshipping_firstname: string;
    Fshipping_firstname_Specified: boolean;
    Fshipping_middlename: string;
    Fshipping_middlename_Specified: boolean;
    Fshipping_lastname: string;
    Fshipping_lastname_Specified: boolean;
    Fshipping_suffix: string;
    Fshipping_suffix_Specified: boolean;
    Fshipping_company: string;
    Fshipping_company_Specified: boolean;
    Fshipping_country_id: string;
    Fshipping_country_id_Specified: boolean;
    Fshipping_region: string;
    Fshipping_region_Specified: boolean;
    Fshipping_region_id: string;
    Fshipping_region_id_Specified: boolean;
    Fshipping_city: string;
    Fshipping_city_Specified: boolean;
    Fshipping_address: string;
    Fshipping_address_Specified: boolean;
    Fshipping_postcode: string;
    Fshipping_postcode_Specified: boolean;
    Fshipping_telephone: string;
    Fshipping_telephone_Specified: boolean;
    Fshipping_fax: string;
    Fshipping_fax_Specified: boolean;
    Fuser_id: string;
    Fuser_id_Specified: boolean;
    Fimported: string;
    Fimported_Specified: boolean;
    Fcurrency: string;
    Fcurrency_Specified: boolean;
    Fno_expiry: string;
    Fno_expiry_Specified: boolean;
    Fno_reminder: string;
    Fno_reminder_Specified: boolean;
    Fno_followup: string;
    Fno_followup_Specified: boolean;
    Fbase_to_quote_rate: string;
    Fbase_to_quote_rate_Specified: boolean;
    Fexpiry: string;
    Fexpiry_Specified: boolean;
    Freminder: string;
    Freminder_Specified: boolean;
    Ffollowup: string;
    Ffollowup_Specified: boolean;
    Fitemprice: string;
    Fitemprice_Specified: boolean;
    Falt_checkout: string;
    Falt_checkout_Specified: boolean;
    Fhash: string;
    Fhash_Specified: boolean;
    Fcreate_hash: string;
    Fcreate_hash_Specified: boolean;
    ...
    Fapplied_taxes: string;
    Fapplied_taxes_Specified: boolean;
    Fshipping_method: string;
    Fshipping_method_Specified: boolean;
    Fshipping_method_title: string;
    Fshipping_method_title_Specified: boolean;
    Fshipping_carrier: string;
    Fshipping_carrier_Specified: boolean;
    Fshipping_carrier_title: string;
    Fshipping_carrier_title_Specified: boolean;
    Fshipping_code: string;
    Fshipping_code_Specified: boolean;
    Fshipping_description: string;
    Fshipping_description_Specified: boolean;
    Faddress_shipping_description: string;
    Faddress_shipping_description_Specified: boolean;
    Faddress_shipping_method: string;
    Faddress_shipping_method_Specified: boolean;
    Fshipping_amount_incl_tax: string;
    Fshipping_amount_incl_tax_Specified: boolean;
    ...
    Fbase_shipping_amount_incl_tax: string;
    Fbase_shipping_amount_incl_tax_Specified: boolean;
    Ffree_shipping: string;
    Ffree_shipping_Specified: boolean;
    Fshipping_base_price: string;
    Fshipping_base_price_Specified: boolean;
    Fcreated_from_quote_id: string;
    Fcreated_from_quote_id_Specified: boolean;
    Fextra_field_1: string;
    Fextra_field_1_Specified: boolean;
    Fextra_field_2: string;
    Fextra_field_2_Specified: boolean;
    Fextra_field_3: string;
    Fextra_field_3_Specified: boolean;
    Fextra_field_4: string;
    Fextra_field_4_Specified: boolean;
    Fcustomer_group_id: string;
    Fcustomer_group_id_Specified: boolean;
    Fpayment_method: string;
    Fpayment_method_Specified: boolean;
    procedure Setproposal_sent(Index: Integer; const Astring: string);
    function  proposal_sent_Specified(Index: Integer): boolean;
    procedure Setstatus(Index: Integer; const Astring: string);
    function  status_Specified(Index: Integer): boolean;
    procedure Setsubstatus(Index: Integer; const Astring: string);
    function  substatus_Specified(Index: Integer): boolean;
    procedure Setsalesrule(Index: Integer; const Astring: string);
    function  salesrule_Specified(Index: Integer): boolean;
    ...
    procedure Setclient_request(Index: Integer; const Astring: string);
    function  client_request_Specified(Index: Integer): boolean;
    procedure Setinternal_comment(Index: Integer; const Astring: string);
    function  internal_comment_Specified(Index: Integer): boolean;
    procedure Setshipping_type(Index: Integer; const Astring: string);
    function  shipping_type_Specified(Index: Integer): boolean;
    procedure Setshipping_price(Index: Integer; const Astring: string);
    function  shipping_price_Specified(Index: Integer): boolean;
    ...
    procedure Setfile_title(Index: Integer; const Astring: string);
    function  file_title_Specified(Index: Integer): boolean;
    procedure Setpath(Index: Integer; const Astring: string);
    function  path_Specified(Index: Integer): boolean;
    procedure Setshipping_prefix(Index: Integer; const Astring: string);
    function  shipping_prefix_Specified(Index: Integer): boolean;
    ...
    procedure Setshipping_middlename(Index: Integer; const Astring: string);
    function  shipping_middlename_Specified(Index: Integer): boolean;
    ...
    procedure Setshipping_suffix(Index: Integer; const Astring: string);
    function  shipping_suffix_Specified(Index: Integer): boolean;
    procedure Setshipping_company(Index: Integer; const Astring: string);
    function  shipping_company_Specified(Index: Integer): boolean;
    procedure Setshipping_country_id(Index: Integer; const Astring: string);
    function  shipping_country_id_Specified(Index: Integer): boolean;
    procedure Setshipping_region(Index: Integer; const Astring: string);
    function  shipping_region_Specified(Index: Integer): boolean;
    procedure Setshipping_region_id(Index: Integer; const Astring: string);
    function  shipping_region_id_Specified(Index: Integer): boolean;
    procedure Setshipping_city(Index: Integer; const Astring: string);
    function  shipping_city_Specified(Index: Integer): boolean;
    procedure Setshipping_address(Index: Integer; const Astring: string);
    function  shipping_address_Specified(Index: Integer): boolean;
    procedure Setshipping_postcode(Index: Integer; const Astring: string);
    function  shipping_postcode_Specified(Index: Integer): boolean;
    procedure Setshipping_telephone(Index: Integer; const Astring: string);
    function  shipping_telephone_Specified(Index: Integer): boolean;
    procedure Setshipping_fax(Index: Integer; const Astring: string);
    function  shipping_fax_Specified(Index: Integer): boolean;
    procedure Setuser_id(Index: Integer; const Astring: string);
    function  user_id_Specified(Index: Integer): boolean;
    procedure Setimported(Index: Integer; const Astring: string);
    function  imported_Specified(Index: Integer): boolean;
    procedure Setcurrency(Index: Integer; const Astring: string);
    function  currency_Specified(Index: Integer): boolean;
    procedure Setno_expiry(Index: Integer; const Astring: string);
    function  no_expiry_Specified(Index: Integer): boolean;
    procedure Setno_reminder(Index: Integer; const Astring: string);
    function  no_reminder_Specified(Index: Integer): boolean;
    procedure Setno_followup(Index: Integer; const Astring: string);
    function  no_followup_Specified(Index: Integer): boolean;
    procedure Setbase_to_quote_rate(Index: Integer; const Astring: string);
    function  base_to_quote_rate_Specified(Index: Integer): boolean;
    procedure Setexpiry(Index: Integer; const Astring: string);
    function  expiry_Specified(Index: Integer): boolean;
    procedure Setreminder(Index: Integer; const Astring: string);
    function  reminder_Specified(Index: Integer): boolean;
    procedure Setfollowup(Index: Integer; const Astring: string);
    function  followup_Specified(Index: Integer): boolean;
    procedure Setitemprice(Index: Integer; const Astring: string);
    function  itemprice_Specified(Index: Integer): boolean;
    procedure Setalt_checkout(Index: Integer; const Astring: string);
    function  alt_checkout_Specified(Index: Integer): boolean;
    procedure Sethash(Index: Integer; const Astring: string);
    function  hash_Specified(Index: Integer): boolean;
    procedure Setcreate_hash(Index: Integer; const Astring: string);
    function  create_hash_Specified(Index: Integer): boolean;
    ...
    procedure Setitems_qty(Index: Integer; const Astring: string);
    function  items_qty_Specified(Index: Integer): boolean;
    procedure Setitems_count(Index: Integer; const Astring: string);
    function  items_count_Specified(Index: Integer): boolean;
    procedure Setapplied_taxes(Index: Integer; const Astring: string);
    function  applied_taxes_Specified(Index: Integer): boolean;
    procedure Setshipping_method(Index: Integer; const Astring: string);
    function  shipping_method_Specified(Index: Integer): boolean;
    procedure Setshipping_method_title(Index: Integer; const Astring: string);
    function  shipping_method_title_Specified(Index: Integer): boolean;
    procedure Setshipping_carrier(Index: Integer; const Astring: string);
    function  shipping_carrier_Specified(Index: Integer): boolean;
    procedure Setshipping_carrier_title(Index: Integer; const Astring: string);
    function  shipping_carrier_title_Specified(Index: Integer): boolean;
    procedure Setshipping_code(Index: Integer; const Astring: string);
    function  shipping_code_Specified(Index: Integer): boolean;
    ...
    procedure Setaddress_shipping_description(Index: Integer; const Astring: string);
    function  address_shipping_description_Specified(Index: Integer): boolean;
    procedure Setaddress_shipping_method(Index: Integer; const Astring: string);
    function  address_shipping_method_Specified(Index: Integer): boolean;
    procedure Setshipping_amount_incl_tax(Index: Integer; const Astring: string);
    function  shipping_amount_incl_tax_Specified(Index: Integer): boolean;
    ...
    procedure Setbase_shipping_amount_incl_tax(Index: Integer; const Astring: string);
    function  base_shipping_amount_incl_tax_Specified(Index: Integer): boolean;
    procedure Setfree_shipping(Index: Integer; const Astring: string);
    function  free_shipping_Specified(Index: Integer): boolean;
    procedure Setshipping_base_price(Index: Integer; const Astring: string);
    function  shipping_base_price_Specified(Index: Integer): boolean;
    procedure Setcreated_from_quote_id(Index: Integer; const Astring: string);
    function  created_from_quote_id_Specified(Index: Integer): boolean;
    procedure Setextra_field_1(Index: Integer; const Astring: string);
    function  extra_field_1_Specified(Index: Integer): boolean;
    procedure Setextra_field_2(Index: Integer; const Astring: string);
    function  extra_field_2_Specified(Index: Integer): boolean;
    procedure Setextra_field_3(Index: Integer; const Astring: string);
    function  extra_field_3_Specified(Index: Integer): boolean;
    procedure Setextra_field_4(Index: Integer; const Astring: string);
    function  extra_field_4_Specified(Index: Integer): boolean;
    ...
    procedure Setpayment_method(Index: Integer; const Astring: string);
    function  payment_method_Specified(Index: Integer): boolean;
  published
    property proposal_sent:                 string  Index (IS_OPTN) read Fproposal_sent write Setproposal_sent stored proposal_sent_Specified;
    property status:                        string  Index (IS_OPTN) read Fstatus write Setstatus stored status_Specified;
    property substatus:                     string  Index (IS_OPTN) read Fsubstatus write Setsubstatus stored substatus_Specified;
    property salesrule:                     string  Index (IS_OPTN) read Fsalesrule write Setsalesrule stored salesrule_Specified;
    ...
    property client_request:                string  Index (IS_OPTN) read Fclient_request write Setclient_request stored client_request_Specified;
    property internal_comment:              string  Index (IS_OPTN) read Finternal_comment write Setinternal_comment stored internal_comment_Specified;
    property shipping_type:                 string  Index (IS_OPTN) read Fshipping_type write Setshipping_type stored shipping_type_Specified;
    property shipping_price:                string  Index (IS_OPTN) read Fshipping_price write Setshipping_price stored shipping_price_Specified;
    ...
    property file_title:                    string  Index (IS_OPTN) read Ffile_title write Setfile_title stored file_title_Specified;
    property path:                          string  Index (IS_OPTN) read Fpath write Setpath stored path_Specified;
    property shipping_prefix:               string  Index (IS_OPTN) read Fshipping_prefix write Setshipping_prefix stored shipping_prefix_Specified;
    ...
    property shipping_middlename:           string  Index (IS_OPTN) read Fshipping_middlename write Setshipping_middlename stored shipping_middlename_Specified;
    ...
    property shipping_suffix:               string  Index (IS_OPTN) read Fshipping_suffix write Setshipping_suffix stored shipping_suffix_Specified;
    property shipping_company:              string  Index (IS_OPTN) read Fshipping_company write Setshipping_company stored shipping_company_Specified;
    property shipping_country_id:           string  Index (IS_OPTN) read Fshipping_country_id write Setshipping_country_id stored shipping_country_id_Specified;
    property shipping_region:               string  Index (IS_OPTN) read Fshipping_region write Setshipping_region stored shipping_region_Specified;
    property shipping_region_id:            string  Index (IS_OPTN) read Fshipping_region_id write Setshipping_region_id stored shipping_region_id_Specified;
    property shipping_city:                 string  Index (IS_OPTN) read Fshipping_city write Setshipping_city stored shipping_city_Specified;
    property shipping_address:              string  Index (IS_OPTN) read Fshipping_address write Setshipping_address stored shipping_address_Specified;
    property shipping_postcode:             string  Index (IS_OPTN) read Fshipping_postcode write Setshipping_postcode stored shipping_postcode_Specified;
    property shipping_telephone:            string  Index (IS_OPTN) read Fshipping_telephone write Setshipping_telephone stored shipping_telephone_Specified;
    property shipping_fax:                  string  Index (IS_OPTN) read Fshipping_fax write Setshipping_fax stored shipping_fax_Specified;
    property user_id:                       string  Index (IS_OPTN) read Fuser_id write Setuser_id stored user_id_Specified;
    property imported:                      string  Index (IS_OPTN) read Fimported write Setimported stored imported_Specified;
    property currency:                      string  Index (IS_OPTN) read Fcurrency write Setcurrency stored currency_Specified;
    property no_expiry:                     string  Index (IS_OPTN) read Fno_expiry write Setno_expiry stored no_expiry_Specified;
    property no_reminder:                   string  Index (IS_OPTN) read Fno_reminder write Setno_reminder stored no_reminder_Specified;
    property no_followup:                   string  Index (IS_OPTN) read Fno_followup write Setno_followup stored no_followup_Specified;
    property base_to_quote_rate:            string  Index (IS_OPTN) read Fbase_to_quote_rate write Setbase_to_quote_rate stored base_to_quote_rate_Specified;
    property expiry:                        string  Index (IS_OPTN) read Fexpiry write Setexpiry stored expiry_Specified;
    property reminder:                      string  Index (IS_OPTN) read Freminder write Setreminder stored reminder_Specified;
    property followup:                      string  Index (IS_OPTN) read Ffollowup write Setfollowup stored followup_Specified;
    property itemprice:                     string  Index (IS_OPTN) read Fitemprice write Setitemprice stored itemprice_Specified;
    property alt_checkout:                  string  Index (IS_OPTN) read Falt_checkout write Setalt_checkout stored alt_checkout_Specified;
    property hash:                          string  Index (IS_OPTN) read Fhash write Sethash stored hash_Specified;
    property create_hash:                   string  Index (IS_OPTN) read Fcreate_hash write Setcreate_hash stored create_hash_Specified;
    ...
    property items_qty:                     string  Index (IS_OPTN) read Fitems_qty write Setitems_qty stored items_qty_Specified;
    property items_count:                   string  Index (IS_OPTN) read Fitems_count write Setitems_count stored items_count_Specified;
    property applied_taxes:                 string  Index (IS_OPTN) read Fapplied_taxes write Setapplied_taxes stored applied_taxes_Specified;
    ...
    property shipping_method_title:         string  Index (IS_OPTN) read Fshipping_method_title write Setshipping_method_title stored shipping_method_title_Specified;
    property shipping_carrier:              string  Index (IS_OPTN) read Fshipping_carrier write Setshipping_carrier stored shipping_carrier_Specified;
    property shipping_carrier_title:        string  Index (IS_OPTN) read Fshipping_carrier_title write Setshipping_carrier_title stored shipping_carrier_title_Specified;
    property shipping_code:                 string  Index (IS_OPTN) read Fshipping_code write Setshipping_code stored shipping_code_Specified;
    ...
    property address_shipping_description:  string  Index (IS_OPTN) read Faddress_shipping_description write Setaddress_shipping_description stored address_shipping_description_Specified;
    property address_shipping_method:       string  Index (IS_OPTN) read Faddress_shipping_method write Setaddress_shipping_method stored address_shipping_method_Specified;
    property shipping_amount_incl_tax:      string  Index (IS_OPTN) read Fshipping_amount_incl_tax write Setshipping_amount_incl_tax stored shipping_amount_incl_tax_Specified;
    ...
    property base_shipping_amount_incl_tax: string  Index (IS_OPTN) read Fbase_shipping_amount_incl_tax write Setbase_shipping_amount_incl_tax stored base_shipping_amount_incl_tax_Specified;
    property free_shipping:                 string  Index (IS_OPTN) read Ffree_shipping write Setfree_shipping stored free_shipping_Specified;
    property shipping_base_price:           string  Index (IS_OPTN) read Fshipping_base_price write Setshipping_base_price stored shipping_base_price_Specified;
    property created_from_quote_id:         string  Index (IS_OPTN) read Fcreated_from_quote_id write Setcreated_from_quote_id stored created_from_quote_id_Specified;
    property extra_field_1:                 string  Index (IS_OPTN) read Fextra_field_1 write Setextra_field_1 stored extra_field_1_Specified;
    property extra_field_2:                 string  Index (IS_OPTN) read Fextra_field_2 write Setextra_field_2 stored extra_field_2_Specified;
    property extra_field_3:                 string  Index (IS_OPTN) read Fextra_field_3 write Setextra_field_3 stored extra_field_3_Specified;
    property extra_field_4:                 string  Index (IS_OPTN) read Fextra_field_4 write Setextra_field_4 stored extra_field_4_Specified;
    ...
    property payment_method:                string  Index (IS_OPTN) read Fpayment_method write Setpayment_method stored payment_method_Specified;
  end;



  // ************************************************************************ //
  // XML       : c2qEntity, global, <complexType>
  // Namespace : urn:Magento
  // ************************************************************************ //
  c2qEntity = class(TRemotable)
  private
    Fquote_id: string;
    ...
    procedure Setupdated_at(Index: Integer; const Astring: string);
    function  updated_at_Specified(Index: Integer): boolean;
    procedure Setis_quote(Index: Integer; const Astring: string);
    function  is_quote_Specified(Index: Integer): boolean;
    procedure Setstatus(Index: Integer; const Astring: string);
    function  status_Specified(Index: Integer): boolean;
    procedure Setcustomer_id(Index: Integer; const Astring: string);
    function  customer_id_Specified(Index: Integer): boolean;
  ...
  published
    ...
    property created_at:          string  Index (IS_OPTN) read Fcreated_at write Setcreated_at stored created_at_Specified;
    property updated_at:          string  Index (IS_OPTN) read Fupdated_at write Setupdated_at stored updated_at_Specified;
    property is_quote:            string  Index (IS_OPTN) read Fis_quote write Setis_quote stored is_quote_Specified;
    property status:              string  Index (IS_OPTN) read Fstatus write Setstatus stored status_Specified;
    property customer_id:         string  Index (IS_OPTN) read Fcustomer_id write Setcustomer_id stored customer_id_Specified;
    property prefix:              string  Index (IS_OPTN) read Fprefix write Setprefix stored prefix_Specified;
    property firstname:           string  Index (IS_OPTN) read Ffirstname write Setfirstname stored firstname_Specified;
  ...
  private
    ...
    Fcustom_use_parent_settings: Integer;
    Fcustom_use_parent_settings_Specified: boolean;
    Fcustom_apply_to_products: Integer;
    Fcustom_apply_to_products_Specified: boolean;
    Ffilter_price_range: string;
    Ffilter_price_range_Specified: boolean;
    procedure Setcreated_at(Index: Integer; const Astring: string);
    function  created_at_Specified(Index: Integer): boolean;
    procedure Setupdated_at(Index: Integer; const Astring: string);
    function  updated_at_Specified(Index: Integer): boolean;
    ...
    procedure Setcustom_use_parent_settings(Index: Integer; const AInteger: Integer);
    function  custom_use_parent_settings_Specified(Index: Integer): boolean;
    procedure Setcustom_apply_to_products(Index: Integer; const AInteger: Integer);
    function  custom_apply_to_products_Specified(Index: Integer): boolean;
    procedure Setfilter_price_range(Index: Integer; const Astring: string);
    function  filter_price_range_Specified(Index: Integer): boolean;
  published
    ...
    property custom_use_parent_settings: Integer        Index (IS_OPTN) read Fcustom_use_parent_settings write Setcustom_use_parent_settings stored custom_use_parent_settings_Specified;
    property custom_apply_to_products:   Integer        Index (IS_OPTN) read Fcustom_apply_to_products write Setcustom_apply_to_products stored custom_apply_to_products_Specified;
    property filter_price_range:         string         Index (IS_OPTN) read Ffilter_price_range write Setfilter_price_range stored filter_price_range_Specified;
  end;
  ...
  // port      : Port
  // URL       : https://www.seton.com.br/index.php/api/v2_soap
  // ************************************************************************ //
  PortType = interface(IInvokable)
  ['{0952B232-FF88-2567-CFE1-036676CDCAAB}']
    ...
    function  c2qList(const sessionId: string; const filters: filters): c2qEntityArray; stdcall;
    function  c2qSet_imported(const sessionId: string; const quote_id: Integer; const value: Boolean): Boolean; stdcall;
    function  c2qInfo(const sessionId: string; const quote_id: Integer): Variant; stdcall;
    function  c2qStatus_list(const sessionId: string): Variant; stdcall;
    function  c2qCreateQuote(const sessionId: string; const data: quoteEntity): Integer; stdcall;
    function  c2qAcceptQuote(const sessionId: string; const quoteId: Integer): Boolean; stdcall;
    function  c2qRejectQuote(const sessionId: string; const quoteId: Integer): Boolean; stdcall;
    function  c2qSend_proposal(const sessionId: string; const quote_id: Integer): Boolean; stdcall;
    function  c2qDelete_requested_qty(const sessionId: string; const quote_id: Integer; const request_id: Integer): Variant; stdcall;
    function  c2qDelete_requested_item(const sessionId: string; const quote_id: Integer; const primary_key: Integer): Variant; stdcall;
    function  c2qModify_requested_qty(const sessionId: string; const quote_id: Integer; const request_id: Integer; const product_id: Integer; const request_qty: Integer; const owner_base_price: string; 
                                      const original_price: string; const quoteadv_product_id: Integer): Variant; stdcall;
    function  c2qSet_item_comment(const sessionId: string; const quoteadv_product_id: Integer; const comment: string): Variant; stdcall;
    function  c2qSet_proposal_comment(const sessionId: string; const quote_id: Integer; const comment: string): Variant; stdcall;
    function  c2qSet_shipping(const sessionId: string; const quote_id: Integer; const shipping_price: string; const shipping_type: string): Variant; stdcall;
    function  c2qAdd_qtybyitem(const sessionId: string; const quote_id: Integer; const product_id: Integer; const quoteadv_product_id: Integer; const request_qty: string; const owner_base_price: string; 
                               const original_price: string): Variant; stdcall;
  end;

function GetPortType(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): PortType;


implementation
  uses SysUtils;

function GetPortType(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): PortType;
const
  defWSDL = 'https://seton.com.br/index.php/api/v2_soap?wsdl=1';
  defURL  = 'https://www.seton.com.br/index.php/api/v2_soap';
...
procedure quoteEntity.Setproposal_sent(Index: Integer; const Astring: string);
begin
  Fproposal_sent := Astring;
  Fproposal_sent_Specified := True;
end;

function quoteEntity.proposal_sent_Specified(Index: Integer): boolean;
begin
  Result := Fproposal_sent_Specified;
end;

procedure quoteEntity.Setstatus(Index: Integer; const Astring: string);
begin
  Fstatus := Astring;
  Fstatus_Specified := True;
end;

function quoteEntity.status_Specified(Index: Integer): boolean;
begin
  Result := Fstatus_Specified;
end;

procedure quoteEntity.Setsubstatus(Index: Integer; const Astring: string);
begin
  Fsubstatus := Astring;
  Fsubstatus_Specified := True;
end;

function quoteEntity.substatus_Specified(Index: Integer): boolean;
begin
  Result := Fsubstatus_Specified;
end;

procedure quoteEntity.Setsalesrule(Index: Integer; const Astring: string);
begin
  Fsalesrule := Astring;
  Fsalesrule_Specified := True;
end;

function quoteEntity.salesrule_Specified(Index: Integer): boolean;
begin
  Result := Fsalesrule_Specified;
end;

procedure quoteEntity.Setcustomer_id(Index: Integer; const Astring: string);
begin
  Fcustomer_id := Astring;
  Fcustomer_id_Specified := True;
end;

function quoteEntity.customer_id_Specified(Index: Integer): boolean;
begin
  Result := Fcustomer_id_Specified;
end;

procedure quoteEntity.Setprefix(Index: Integer; const Astring: string);
begin
  Fprefix := Astring;
  Fprefix_Specified := True;
end;

function quoteEntity.prefix_Specified(Index: Integer): boolean;
begin
  Result := Fprefix_Specified;
end;

procedure quoteEntity.Setfirstname(Index: Integer; const Astring: string);
begin
  Ffirstname := Astring;
  Ffirstname_Specified := True;
end;

function quoteEntity.firstname_Specified(Index: Integer): boolean;
begin
  Result := Ffirstname_Specified;
end;

procedure quoteEntity.Setmiddlename(Index: Integer; const Astring: string);
begin
  Fmiddlename := Astring;
  Fmiddlename_Specified := True;
end;

function quoteEntity.middlename_Specified(Index: Integer): boolean;
begin
  Result := Fmiddlename_Specified;
end;

procedure quoteEntity.Setlastname(Index: Integer; const Astring: string);
begin
  Flastname := Astring;
  Flastname_Specified := True;
end;

function quoteEntity.lastname_Specified(Index: Integer): boolean;
begin
  Result := Flastname_Specified;
end;

procedure quoteEntity.Setsuffix(Index: Integer; const Astring: string);
begin
  Fsuffix := Astring;
  Fsuffix_Specified := True;
end;

function quoteEntity.suffix_Specified(Index: Integer): boolean;
begin
  Result := Fsuffix_Specified;
end;

procedure quoteEntity.Setcompany(Index: Integer; const Astring: string);
begin
  Fcompany := Astring;
  Fcompany_Specified := True;
end;

function quoteEntity.company_Specified(Index: Integer): boolean;
begin
  Result := Fcompany_Specified;
end;

procedure quoteEntity.Setemail(Index: Integer; const Astring: string);
begin
  Femail := Astring;
  Femail_Specified := True;
end;

function quoteEntity.email_Specified(Index: Integer): boolean;
begin
  Result := Femail_Specified;
end;

procedure quoteEntity.Setcountry_id(Index: Integer; const Astring: string);
begin
  Fcountry_id := Astring;
  Fcountry_id_Specified := True;
end;

function quoteEntity.country_id_Specified(Index: Integer): boolean;
begin
  Result := Fcountry_id_Specified;
end;

procedure quoteEntity.Setregion(Index: Integer; const Astring: string);
begin
  Fregion := Astring;
  Fregion_Specified := True;
end;

function quoteEntity.region_Specified(Index: Integer): boolean;
begin
  Result := Fregion_Specified;
end;

procedure quoteEntity.Setregion_id(Index: Integer; const Astring: string);
begin
  Fregion_id := Astring;
  Fregion_id_Specified := True;
end;

function quoteEntity.region_id_Specified(Index: Integer): boolean;
begin
  Result := Fregion_id_Specified;
end;

procedure quoteEntity.Setcity(Index: Integer; const Astring: string);
begin
  Fcity := Astring;
  Fcity_Specified := True;
end;

function quoteEntity.city_Specified(Index: Integer): boolean;
begin
  Result := Fcity_Specified;
end;

procedure quoteEntity.Setaddress(Index: Integer; const Astring: string);
begin
  Faddress := Astring;
  Faddress_Specified := True;
end;

function quoteEntity.address_Specified(Index: Integer): boolean;
begin
  Result := Faddress_Specified;
end;

procedure quoteEntity.Setpostcode(Index: Integer; const Astring: string);
begin
  Fpostcode := Astring;
  Fpostcode_Specified := True;
end;

function quoteEntity.postcode_Specified(Index: Integer): boolean;
begin
  Result := Fpostcode_Specified;
end;

procedure quoteEntity.Settelephone(Index: Integer; const Astring: string);
begin
  Ftelephone := Astring;
  Ftelephone_Specified := True;
end;

function quoteEntity.telephone_Specified(Index: Integer): boolean;
begin
  Result := Ftelephone_Specified;
end;

procedure quoteEntity.Setfax(Index: Integer; const Astring: string);
begin
  Ffax := Astring;
  Ffax_Specified := True;
end;

function quoteEntity.fax_Specified(Index: Integer): boolean;
begin
  Result := Ffax_Specified;
end;

procedure quoteEntity.Setclient_request(Index: Integer; const Astring: string);
begin
  Fclient_request := Astring;
  Fclient_request_Specified := True;
end;

function quoteEntity.client_request_Specified(Index: Integer): boolean;
begin
  Result := Fclient_request_Specified;
end;

procedure quoteEntity.Setinternal_comment(Index: Integer; const Astring: string);
begin
  Finternal_comment := Astring;
  Finternal_comment_Specified := True;
end;

function quoteEntity.internal_comment_Specified(Index: Integer): boolean;
begin
  Result := Finternal_comment_Specified;
end;

procedure quoteEntity.Setshipping_type(Index: Integer; const Astring: string);
begin
  Fshipping_type := Astring;
  Fshipping_type_Specified := True;
end;

function quoteEntity.shipping_type_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_type_Specified;
end;

procedure quoteEntity.Setshipping_price(Index: Integer; const Astring: string);
begin
  Fshipping_price := Astring;
  Fshipping_price_Specified := True;
end;

function quoteEntity.shipping_price_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_price_Specified;
end;

procedure quoteEntity.Setstore_id(Index: Integer; const Astring: string);
begin
  Fstore_id := Astring;
  Fstore_id_Specified := True;
end;

function quoteEntity.store_id_Specified(Index: Integer): boolean;
begin
  Result := Fstore_id_Specified;
end;

procedure quoteEntity.Setincrement_id(Index: Integer; const Astring: string);
begin
  Fincrement_id := Astring;
  Fincrement_id_Specified := True;
end;

function quoteEntity.increment_id_Specified(Index: Integer): boolean;
begin
  Result := Fincrement_id_Specified;
end;

procedure quoteEntity.Setoriginal_increment_id(Index: Integer; const Astring: string);
begin
  Foriginal_increment_id := Astring;
  Foriginal_increment_id_Specified := True;
end;

function quoteEntity.original_increment_id_Specified(Index: Integer): boolean;
begin
  Result := Foriginal_increment_id_Specified;
end;

procedure quoteEntity.Setrelation_child_id(Index: Integer; const Astring: string);
begin
  Frelation_child_id := Astring;
  Frelation_child_id_Specified := True;
end;

function quoteEntity.relation_child_id_Specified(Index: Integer): boolean;
begin
  Result := Frelation_child_id_Specified;
end;

procedure quoteEntity.Setrelation_child_real_id(Index: Integer; const Astring: string);
begin
  Frelation_child_real_id := Astring;
  Frelation_child_real_id_Specified := True;
end;

function quoteEntity.relation_child_real_id_Specified(Index: Integer): boolean;
begin
  Result := Frelation_child_real_id_Specified;
end;

procedure quoteEntity.Setrelation_parent_id(Index: Integer; const Astring: string);
begin
  Frelation_parent_id := Astring;
  Frelation_parent_id_Specified := True;
end;

function quoteEntity.relation_parent_id_Specified(Index: Integer): boolean;
begin
  Result := Frelation_parent_id_Specified;
end;

procedure quoteEntity.Setrelation_parent_real_id(Index: Integer; const Astring: string);
begin
  Frelation_parent_real_id := Astring;
  Frelation_parent_real_id_Specified := True;
end;

function quoteEntity.relation_parent_real_id_Specified(Index: Integer): boolean;
begin
  Result := Frelation_parent_real_id_Specified;
end;

procedure quoteEntity.Setfile_title(Index: Integer; const Astring: string);
begin
  Ffile_title := Astring;
  Ffile_title_Specified := True;
end;

function quoteEntity.file_title_Specified(Index: Integer): boolean;
begin
  Result := Ffile_title_Specified;
end;

procedure quoteEntity.Setpath(Index: Integer; const Astring: string);
begin
  Fpath := Astring;
  Fpath_Specified := True;
end;

function quoteEntity.path_Specified(Index: Integer): boolean;
begin
  Result := Fpath_Specified;
end;

procedure quoteEntity.Setshipping_prefix(Index: Integer; const Astring: string);
begin
  Fshipping_prefix := Astring;
  Fshipping_prefix_Specified := True;
end;

function quoteEntity.shipping_prefix_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_prefix_Specified;
end;

procedure quoteEntity.Setshipping_firstname(Index: Integer; const Astring: string);
begin
  Fshipping_firstname := Astring;
  Fshipping_firstname_Specified := True;
end;

function quoteEntity.shipping_firstname_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_firstname_Specified;
end;

procedure quoteEntity.Setshipping_middlename(Index: Integer; const Astring: string);
begin
  Fshipping_middlename := Astring;
  Fshipping_middlename_Specified := True;
end;

function quoteEntity.shipping_middlename_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_middlename_Specified;
end;

procedure quoteEntity.Setshipping_lastname(Index: Integer; const Astring: string);
begin
  Fshipping_lastname := Astring;
  Fshipping_lastname_Specified := True;
end;

function quoteEntity.shipping_lastname_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_lastname_Specified;
end;

procedure quoteEntity.Setshipping_suffix(Index: Integer; const Astring: string);
begin
  Fshipping_suffix := Astring;
  Fshipping_suffix_Specified := True;
end;

function quoteEntity.shipping_suffix_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_suffix_Specified;
end;

procedure quoteEntity.Setshipping_company(Index: Integer; const Astring: string);
begin
  Fshipping_company := Astring;
  Fshipping_company_Specified := True;
end;

function quoteEntity.shipping_company_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_company_Specified;
end;

procedure quoteEntity.Setshipping_country_id(Index: Integer; const Astring: string);
begin
  Fshipping_country_id := Astring;
  Fshipping_country_id_Specified := True;
end;

function quoteEntity.shipping_country_id_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_country_id_Specified;
end;

procedure quoteEntity.Setshipping_region(Index: Integer; const Astring: string);
begin
  Fshipping_region := Astring;
  Fshipping_region_Specified := True;
end;

function quoteEntity.shipping_region_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_region_Specified;
end;

procedure quoteEntity.Setshipping_region_id(Index: Integer; const Astring: string);
begin
  Fshipping_region_id := Astring;
  Fshipping_region_id_Specified := True;
end;

function quoteEntity.shipping_region_id_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_region_id_Specified;
end;

procedure quoteEntity.Setshipping_city(Index: Integer; const Astring: string);
begin
  Fshipping_city := Astring;
  Fshipping_city_Specified := True;
end;

function quoteEntity.shipping_city_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_city_Specified;
end;

procedure quoteEntity.Setshipping_address(Index: Integer; const Astring: string);
begin
  Fshipping_address := Astring;
  Fshipping_address_Specified := True;
end;

function quoteEntity.shipping_address_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_address_Specified;
end;

procedure quoteEntity.Setshipping_postcode(Index: Integer; const Astring: string);
begin
  Fshipping_postcode := Astring;
  Fshipping_postcode_Specified := True;
end;

function quoteEntity.shipping_postcode_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_postcode_Specified;
end;

procedure quoteEntity.Setshipping_telephone(Index: Integer; const Astring: string);
begin
  Fshipping_telephone := Astring;
  Fshipping_telephone_Specified := True;
end;

function quoteEntity.shipping_telephone_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_telephone_Specified;
end;

procedure quoteEntity.Setshipping_fax(Index: Integer; const Astring: string);
begin
  Fshipping_fax := Astring;
  Fshipping_fax_Specified := True;
end;

function quoteEntity.shipping_fax_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_fax_Specified;
end;

procedure quoteEntity.Setuser_id(Index: Integer; const Astring: string);
begin
  Fuser_id := Astring;
  Fuser_id_Specified := True;
end;

function quoteEntity.user_id_Specified(Index: Integer): boolean;
begin
  Result := Fuser_id_Specified;
end;

procedure quoteEntity.Setimported(Index: Integer; const Astring: string);
begin
  Fimported := Astring;
  Fimported_Specified := True;
end;

function quoteEntity.imported_Specified(Index: Integer): boolean;
begin
  Result := Fimported_Specified;
end;

procedure quoteEntity.Setcurrency(Index: Integer; const Astring: string);
begin
  Fcurrency := Astring;
  Fcurrency_Specified := True;
end;

function quoteEntity.currency_Specified(Index: Integer): boolean;
begin
  Result := Fcurrency_Specified;
end;

procedure quoteEntity.Setno_expiry(Index: Integer; const Astring: string);
begin
  Fno_expiry := Astring;
  Fno_expiry_Specified := True;
end;

function quoteEntity.no_expiry_Specified(Index: Integer): boolean;
begin
  Result := Fno_expiry_Specified;
end;

procedure quoteEntity.Setno_reminder(Index: Integer; const Astring: string);
begin
  Fno_reminder := Astring;
  Fno_reminder_Specified := True;
end;

function quoteEntity.no_reminder_Specified(Index: Integer): boolean;
begin
  Result := Fno_reminder_Specified;
end;

procedure quoteEntity.Setno_followup(Index: Integer; const Astring: string);
begin
  Fno_followup := Astring;
  Fno_followup_Specified := True;
end;

function quoteEntity.no_followup_Specified(Index: Integer): boolean;
begin
  Result := Fno_followup_Specified;
end;

procedure quoteEntity.Setbase_to_quote_rate(Index: Integer; const Astring: string);
begin
  Fbase_to_quote_rate := Astring;
  Fbase_to_quote_rate_Specified := True;
end;

function quoteEntity.base_to_quote_rate_Specified(Index: Integer): boolean;
begin
  Result := Fbase_to_quote_rate_Specified;
end;

procedure quoteEntity.Setexpiry(Index: Integer; const Astring: string);
begin
  Fexpiry := Astring;
  Fexpiry_Specified := True;
end;

function quoteEntity.expiry_Specified(Index: Integer): boolean;
begin
  Result := Fexpiry_Specified;
end;

procedure quoteEntity.Setreminder(Index: Integer; const Astring: string);
begin
  Freminder := Astring;
  Freminder_Specified := True;
end;

function quoteEntity.reminder_Specified(Index: Integer): boolean;
begin
  Result := Freminder_Specified;
end;

procedure quoteEntity.Setfollowup(Index: Integer; const Astring: string);
begin
  Ffollowup := Astring;
  Ffollowup_Specified := True;
end;

function quoteEntity.followup_Specified(Index: Integer): boolean;
begin
  Result := Ffollowup_Specified;
end;

procedure quoteEntity.Setitemprice(Index: Integer; const Astring: string);
begin
  Fitemprice := Astring;
  Fitemprice_Specified := True;
end;

function quoteEntity.itemprice_Specified(Index: Integer): boolean;
begin
  Result := Fitemprice_Specified;
end;

procedure quoteEntity.Setalt_checkout(Index: Integer; const Astring: string);
begin
  Falt_checkout := Astring;
  Falt_checkout_Specified := True;
end;

function quoteEntity.alt_checkout_Specified(Index: Integer): boolean;
begin
  Result := Falt_checkout_Specified;
end;

procedure quoteEntity.Sethash(Index: Integer; const Astring: string);
begin
  Fhash := Astring;
  Fhash_Specified := True;
end;

function quoteEntity.hash_Specified(Index: Integer): boolean;
begin
  Result := Fhash_Specified;
end;

procedure quoteEntity.Setcreate_hash(Index: Integer; const Astring: string);
begin
  Fcreate_hash := Astring;
  Fcreate_hash_Specified := True;
end;

function quoteEntity.create_hash_Specified(Index: Integer): boolean;
begin
  Result := Fcreate_hash_Specified;
end;

procedure quoteEntity.Setbase_subtotal(Index: Integer; const Astring: string);
begin
  Fbase_subtotal := Astring;
  Fbase_subtotal_Specified := True;
end;

function quoteEntity.base_subtotal_Specified(Index: Integer): boolean;
begin
  Result := Fbase_subtotal_Specified;
end;

procedure quoteEntity.Setbase_grand_total(Index: Integer; const Astring: string);
begin
  Fbase_grand_total := Astring;
  Fbase_grand_total_Specified := True;
end;

function quoteEntity.base_grand_total_Specified(Index: Integer): boolean;
begin
  Result := Fbase_grand_total_Specified;
end;

procedure quoteEntity.Setbase_shipping_amount(Index: Integer; const Astring: string);
begin
  Fbase_shipping_amount := Astring;
  Fbase_shipping_amount_Specified := True;
end;

function quoteEntity.base_shipping_amount_Specified(Index: Integer): boolean;
begin
  Result := Fbase_shipping_amount_Specified;
end;

procedure quoteEntity.Setbase_tax_amount(Index: Integer; const Astring: string);
begin
  Fbase_tax_amount := Astring;
  Fbase_tax_amount_Specified := True;
end;

function quoteEntity.base_tax_amount_Specified(Index: Integer): boolean;
begin
  Result := Fbase_tax_amount_Specified;
end;

procedure quoteEntity.Setshipping_amount(Index: Integer; const Astring: string);
begin
  Fshipping_amount := Astring;
  Fshipping_amount_Specified := True;
end;

function quoteEntity.shipping_amount_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_amount_Specified;
end;

procedure quoteEntity.Setgrand_total(Index: Integer; const Astring: string);
begin
  Fgrand_total := Astring;
  Fgrand_total_Specified := True;
end;

function quoteEntity.grand_total_Specified(Index: Integer): boolean;
begin
  Result := Fgrand_total_Specified;
end;

procedure quoteEntity.Settax_amount(Index: Integer; const Astring: string);
begin
  Ftax_amount := Astring;
  Ftax_amount_Specified := True;
end;

function quoteEntity.tax_amount_Specified(Index: Integer): boolean;
begin
  Result := Ftax_amount_Specified;
end;

procedure quoteEntity.Setsubtotal(Index: Integer; const Astring: string);
begin
  Fsubtotal := Astring;
  Fsubtotal_Specified := True;
end;

function quoteEntity.subtotal_Specified(Index: Integer): boolean;
begin
  Result := Fsubtotal_Specified;
end;

procedure quoteEntity.Setsubtotal_incl_tax(Index: Integer; const Astring: string);
begin
  Fsubtotal_incl_tax := Astring;
  Fsubtotal_incl_tax_Specified := True;
end;

function quoteEntity.subtotal_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fsubtotal_incl_tax_Specified;
end;

procedure quoteEntity.Setshipping_incl_tax(Index: Integer; const Astring: string);
begin
  Fshipping_incl_tax := Astring;
  Fshipping_incl_tax_Specified := True;
end;

function quoteEntity.shipping_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_incl_tax_Specified;
end;

procedure quoteEntity.Setbase_shipping_incl_tax(Index: Integer; const Astring: string);
begin
  Fbase_shipping_incl_tax := Astring;
  Fbase_shipping_incl_tax_Specified := True;
end;

function quoteEntity.base_shipping_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fbase_shipping_incl_tax_Specified;
end;

procedure quoteEntity.Setbase_subtotal_incl_tax(Index: Integer; const Astring: string);
begin
  Fbase_subtotal_incl_tax := Astring;
  Fbase_subtotal_incl_tax_Specified := True;
end;

function quoteEntity.base_subtotal_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fbase_subtotal_incl_tax_Specified;
end;

procedure quoteEntity.Setitems_qty(Index: Integer; const Astring: string);
begin
  Fitems_qty := Astring;
  Fitems_qty_Specified := True;
end;

function quoteEntity.items_qty_Specified(Index: Integer): boolean;
begin
  Result := Fitems_qty_Specified;
end;

procedure quoteEntity.Setitems_count(Index: Integer; const Astring: string);
begin
  Fitems_count := Astring;
  Fitems_count_Specified := True;
end;

function quoteEntity.items_count_Specified(Index: Integer): boolean;
begin
  Result := Fitems_count_Specified;
end;

procedure quoteEntity.Setapplied_taxes(Index: Integer; const Astring: string);
begin
  Fapplied_taxes := Astring;
  Fapplied_taxes_Specified := True;
end;

function quoteEntity.applied_taxes_Specified(Index: Integer): boolean;
begin
  Result := Fapplied_taxes_Specified;
end;

procedure quoteEntity.Setshipping_method(Index: Integer; const Astring: string);
begin
  Fshipping_method := Astring;
  Fshipping_method_Specified := True;
end;

function quoteEntity.shipping_method_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_method_Specified;
end;

procedure quoteEntity.Setshipping_method_title(Index: Integer; const Astring: string);
begin
  Fshipping_method_title := Astring;
  Fshipping_method_title_Specified := True;
end;

function quoteEntity.shipping_method_title_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_method_title_Specified;
end;

procedure quoteEntity.Setshipping_carrier(Index: Integer; const Astring: string);
begin
  Fshipping_carrier := Astring;
  Fshipping_carrier_Specified := True;
end;

function quoteEntity.shipping_carrier_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_carrier_Specified;
end;

procedure quoteEntity.Setshipping_carrier_title(Index: Integer; const Astring: string);
begin
  Fshipping_carrier_title := Astring;
  Fshipping_carrier_title_Specified := True;
end;

function quoteEntity.shipping_carrier_title_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_carrier_title_Specified;
end;

procedure quoteEntity.Setshipping_code(Index: Integer; const Astring: string);
begin
  Fshipping_code := Astring;
  Fshipping_code_Specified := True;
end;

function quoteEntity.shipping_code_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_code_Specified;
end;

procedure quoteEntity.Setshipping_description(Index: Integer; const Astring: string);
begin
  Fshipping_description := Astring;
  Fshipping_description_Specified := True;
end;

function quoteEntity.shipping_description_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_description_Specified;
end;

procedure quoteEntity.Setaddress_shipping_description(Index: Integer; const Astring: string);
begin
  Faddress_shipping_description := Astring;
  Faddress_shipping_description_Specified := True;
end;

function quoteEntity.address_shipping_description_Specified(Index: Integer): boolean;
begin
  Result := Faddress_shipping_description_Specified;
end;

procedure quoteEntity.Setaddress_shipping_method(Index: Integer; const Astring: string);
begin
  Faddress_shipping_method := Astring;
  Faddress_shipping_method_Specified := True;
end;

function quoteEntity.address_shipping_method_Specified(Index: Integer): boolean;
begin
  Result := Faddress_shipping_method_Specified;
end;

procedure quoteEntity.Setshipping_amount_incl_tax(Index: Integer; const Astring: string);
begin
  Fshipping_amount_incl_tax := Astring;
  Fshipping_amount_incl_tax_Specified := True;
end;

function quoteEntity.shipping_amount_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_amount_incl_tax_Specified;
end;

procedure quoteEntity.Setbase_shipping_tax_amount(Index: Integer; const Astring: string);
begin
  Fbase_shipping_tax_amount := Astring;
  Fbase_shipping_tax_amount_Specified := True;
end;

function quoteEntity.base_shipping_tax_amount_Specified(Index: Integer): boolean;
begin
  Result := Fbase_shipping_tax_amount_Specified;
end;

procedure quoteEntity.Setshipping_tax_amount(Index: Integer; const Astring: string);
begin
  Fshipping_tax_amount := Astring;
  Fshipping_tax_amount_Specified := True;
end;

function quoteEntity.shipping_tax_amount_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_tax_amount_Specified;
end;

procedure quoteEntity.Setbase_shipping_amount_incl_tax(Index: Integer; const Astring: string);
begin
  Fbase_shipping_amount_incl_tax := Astring;
  Fbase_shipping_amount_incl_tax_Specified := True;
end;

function quoteEntity.base_shipping_amount_incl_tax_Specified(Index: Integer): boolean;
begin
  Result := Fbase_shipping_amount_incl_tax_Specified;
end;

procedure quoteEntity.Setfree_shipping(Index: Integer; const Astring: string);
begin
  Ffree_shipping := Astring;
  Ffree_shipping_Specified := True;
end;

function quoteEntity.free_shipping_Specified(Index: Integer): boolean;
begin
  Result := Ffree_shipping_Specified;
end;

procedure quoteEntity.Setshipping_base_price(Index: Integer; const Astring: string);
begin
  Fshipping_base_price := Astring;
  Fshipping_base_price_Specified := True;
end;

function quoteEntity.shipping_base_price_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_base_price_Specified;
end;

procedure quoteEntity.Setcreated_from_quote_id(Index: Integer; const Astring: string);
begin
  Fcreated_from_quote_id := Astring;
  Fcreated_from_quote_id_Specified := True;
end;

function quoteEntity.created_from_quote_id_Specified(Index: Integer): boolean;
begin
  Result := Fcreated_from_quote_id_Specified;
end;

procedure quoteEntity.Setextra_field_1(Index: Integer; const Astring: string);
begin
  Fextra_field_1 := Astring;
  Fextra_field_1_Specified := True;
end;

function quoteEntity.extra_field_1_Specified(Index: Integer): boolean;
begin
  Result := Fextra_field_1_Specified;
end;

procedure quoteEntity.Setextra_field_2(Index: Integer; const Astring: string);
begin
  Fextra_field_2 := Astring;
  Fextra_field_2_Specified := True;
end;

function quoteEntity.extra_field_2_Specified(Index: Integer): boolean;
begin
  Result := Fextra_field_2_Specified;
end;

procedure quoteEntity.Setextra_field_3(Index: Integer; const Astring: string);
begin
  Fextra_field_3 := Astring;
  Fextra_field_3_Specified := True;
end;

function quoteEntity.extra_field_3_Specified(Index: Integer): boolean;
begin
  Result := Fextra_field_3_Specified;
end;

procedure quoteEntity.Setextra_field_4(Index: Integer; const Astring: string);
begin
  Fextra_field_4 := Astring;
  Fextra_field_4_Specified := True;
end;

function quoteEntity.extra_field_4_Specified(Index: Integer): boolean;
begin
  Result := Fextra_field_4_Specified;
end;

procedure quoteEntity.Setcustomer_group_id(Index: Integer; const Astring: string);
begin
  Fcustomer_group_id := Astring;
  Fcustomer_group_id_Specified := True;
end;

function quoteEntity.customer_group_id_Specified(Index: Integer): boolean;
begin
  Result := Fcustomer_group_id_Specified;
end;

procedure quoteEntity.Setpayment_method(Index: Integer; const Astring: string);
begin
  Fpayment_method := Astring;
  Fpayment_method_Specified := True;
end;

function quoteEntity.payment_method_Specified(Index: Integer): boolean;
begin
  Result := Fpayment_method_Specified;
end;

procedure c2qEntity.Setquote_id(Index: Integer; const Astring: string);
begin
  Fquote_id := Astring;
  Fquote_id_Specified := True;
end;

function c2qEntity.quote_id_Specified(Index: Integer): boolean;
begin
  Result := Fquote_id_Specified;
end;

procedure c2qEntity.Setcreated_at(Index: Integer; const Astring: string);
begin
  Fcreated_at := Astring;
  Fcreated_at_Specified := True;
end;

function c2qEntity.created_at_Specified(Index: Integer): boolean;
begin
  Result := Fcreated_at_Specified;
end;

procedure c2qEntity.Setupdated_at(Index: Integer; const Astring: string);
begin
  Fupdated_at := Astring;
  Fupdated_at_Specified := True;
end;

function c2qEntity.updated_at_Specified(Index: Integer): boolean;
begin
  Result := Fupdated_at_Specified;
end;

procedure c2qEntity.Setis_quote(Index: Integer; const Astring: string);
begin
  Fis_quote := Astring;
  Fis_quote_Specified := True;
end;

function c2qEntity.is_quote_Specified(Index: Integer): boolean;
begin
  Result := Fis_quote_Specified;
end;

procedure c2qEntity.Setstatus(Index: Integer; const Astring: string);
begin
  Fstatus := Astring;
  Fstatus_Specified := True;
end;

function c2qEntity.status_Specified(Index: Integer): boolean;
begin
  Result := Fstatus_Specified;
end;

procedure c2qEntity.Setcustomer_id(Index: Integer; const Astring: string);
begin
  Fcustomer_id := Astring;
  Fcustomer_id_Specified := True;
end;

function c2qEntity.customer_id_Specified(Index: Integer): boolean;
begin
  Result := Fcustomer_id_Specified;
end;

procedure c2qEntity.Setprefix(Index: Integer; const Astring: string);
begin
  Fprefix := Astring;
  Fprefix_Specified := True;
end;

function c2qEntity.prefix_Specified(Index: Integer): boolean;
begin
  Result := Fprefix_Specified;
end;

procedure c2qEntity.Setfirstname(Index: Integer; const Astring: string);
begin
  Ffirstname := Astring;
  Ffirstname_Specified := True;
end;

function c2qEntity.firstname_Specified(Index: Integer): boolean;
begin
  Result := Ffirstname_Specified;
end;

procedure c2qEntity.Setmiddlename(Index: Integer; const Astring: string);
begin
  Fmiddlename := Astring;
  Fmiddlename_Specified := True;
end;

function c2qEntity.middlename_Specified(Index: Integer): boolean;
begin
  Result := Fmiddlename_Specified;
end;

procedure c2qEntity.Setlastname(Index: Integer; const Astring: string);
begin
  Flastname := Astring;
  Flastname_Specified := True;
end;

function c2qEntity.lastname_Specified(Index: Integer): boolean;
begin
  Result := Flastname_Specified;
end;

procedure c2qEntity.Setsuffix(Index: Integer; const Astring: string);
begin
  Fsuffix := Astring;
  Fsuffix_Specified := True;
end;

function c2qEntity.suffix_Specified(Index: Integer): boolean;
begin
  Result := Fsuffix_Specified;
end;

procedure c2qEntity.Setcompany(Index: Integer; const Astring: string);
begin
  Fcompany := Astring;
  Fcompany_Specified := True;
end;

function c2qEntity.company_Specified(Index: Integer): boolean;
begin
  Result := Fcompany_Specified;
end;

procedure c2qEntity.Setemail(Index: Integer; const Astring: string);
begin
  Femail := Astring;
  Femail_Specified := True;
end;

function c2qEntity.email_Specified(Index: Integer): boolean;
begin
  Result := Femail_Specified;
end;

procedure c2qEntity.Setcountry_id(Index: Integer; const Astring: string);
begin
  Fcountry_id := Astring;
  Fcountry_id_Specified := True;
end;

function c2qEntity.country_id_Specified(Index: Integer): boolean;
begin
  Result := Fcountry_id_Specified;
end;

procedure c2qEntity.Setregion(Index: Integer; const Astring: string);
begin
  Fregion := Astring;
  Fregion_Specified := True;
end;

function c2qEntity.region_Specified(Index: Integer): boolean;
begin
  Result := Fregion_Specified;
end;

procedure c2qEntity.Setregion_id(Index: Integer; const Astring: string);
begin
  Fregion_id := Astring;
  Fregion_id_Specified := True;
end;

function c2qEntity.region_id_Specified(Index: Integer): boolean;
begin
  Result := Fregion_id_Specified;
end;

procedure c2qEntity.Setcity(Index: Integer; const Astring: string);
begin
  Fcity := Astring;
  Fcity_Specified := True;
end;

function c2qEntity.city_Specified(Index: Integer): boolean;
begin
  Result := Fcity_Specified;
end;

procedure c2qEntity.Setaddress(Index: Integer; const Astring: string);
begin
  Faddress := Astring;
  Faddress_Specified := True;
end;

function c2qEntity.address_Specified(Index: Integer): boolean;
begin
  Result := Faddress_Specified;
end;

procedure c2qEntity.Setpostcode(Index: Integer; const Astring: string);
begin
  Fpostcode := Astring;
  Fpostcode_Specified := True;
end;

function c2qEntity.postcode_Specified(Index: Integer): boolean;
begin
  Result := Fpostcode_Specified;
end;

procedure c2qEntity.Settelephone(Index: Integer; const Astring: string);
begin
  Ftelephone := Astring;
  Ftelephone_Specified := True;
end;

function c2qEntity.telephone_Specified(Index: Integer): boolean;
begin
  Result := Ftelephone_Specified;
end;

procedure c2qEntity.Setfax(Index: Integer; const Astring: string);
begin
  Ffax := Astring;
  Ffax_Specified := True;
end;

function c2qEntity.fax_Specified(Index: Integer): boolean;
begin
  Result := Ffax_Specified;
end;

procedure c2qEntity.Setclient_request(Index: Integer; const Astring: string);
begin
  Fclient_request := Astring;
  Fclient_request_Specified := True;
end;

function c2qEntity.client_request_Specified(Index: Integer): boolean;
begin
  Result := Fclient_request_Specified;
end;

procedure c2qEntity.Setshipping_type(Index: Integer; const Astring: string);
begin
  Fshipping_type := Astring;
  Fshipping_type_Specified := True;
end;

function c2qEntity.shipping_type_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_type_Specified;
end;

procedure c2qEntity.Setshipping_price(Index: Integer; const Astring: string);
begin
  Fshipping_price := Astring;
  Fshipping_price_Specified := True;
end;

function c2qEntity.shipping_price_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_price_Specified;
end;

procedure c2qEntity.Setstore_id(Index: Integer; const Astring: string);
begin
  Fstore_id := Astring;
  Fstore_id_Specified := True;
end;

function c2qEntity.store_id_Specified(Index: Integer): boolean;
begin
  Result := Fstore_id_Specified;
end;

procedure c2qEntity.Setincrement_id(Index: Integer; const Astring: string);
begin
  Fincrement_id := Astring;
  Fincrement_id_Specified := True;
end;

function c2qEntity.increment_id_Specified(Index: Integer): boolean;
begin
  Result := Fincrement_id_Specified;
end;

procedure c2qEntity.Setfile_title(Index: Integer; const Astring: string);
begin
  Ffile_title := Astring;
  Ffile_title_Specified := True;
end;

function c2qEntity.file_title_Specified(Index: Integer): boolean;
begin
  Result := Ffile_title_Specified;
end;

procedure c2qEntity.Setpath(Index: Integer; const Astring: string);
begin
  Fpath := Astring;
  Fpath_Specified := True;
end;

function c2qEntity.path_Specified(Index: Integer): boolean;
begin
  Result := Fpath_Specified;
end;

procedure c2qEntity.Setshipping_prefix(Index: Integer; const Astring: string);
begin
  Fshipping_prefix := Astring;
  Fshipping_prefix_Specified := True;
end;

function c2qEntity.shipping_prefix_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_prefix_Specified;
end;

procedure c2qEntity.Setshipping_firstname(Index: Integer; const Astring: string);
begin
  Fshipping_firstname := Astring;
  Fshipping_firstname_Specified := True;
end;

function c2qEntity.shipping_firstname_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_firstname_Specified;
end;

procedure c2qEntity.Setshipping_middlename(Index: Integer; const Astring: string);
begin
  Fshipping_middlename := Astring;
  Fshipping_middlename_Specified := True;
end;

function c2qEntity.shipping_middlename_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_middlename_Specified;
end;

procedure c2qEntity.Setshipping_lastname(Index: Integer; const Astring: string);
begin
  Fshipping_lastname := Astring;
  Fshipping_lastname_Specified := True;
end;

function c2qEntity.shipping_lastname_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_lastname_Specified;
end;

procedure c2qEntity.Setshipping_suffix(Index: Integer; const Astring: string);
begin
  Fshipping_suffix := Astring;
  Fshipping_suffix_Specified := True;
end;

function c2qEntity.shipping_suffix_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_suffix_Specified;
end;

procedure c2qEntity.Setshipping_company(Index: Integer; const Astring: string);
begin
  Fshipping_company := Astring;
  Fshipping_company_Specified := True;
end;

function c2qEntity.shipping_company_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_company_Specified;
end;

procedure c2qEntity.Setshipping_country_id(Index: Integer; const Astring: string);
begin
  Fshipping_country_id := Astring;
  Fshipping_country_id_Specified := True;
end;

function c2qEntity.shipping_country_id_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_country_id_Specified;
end;

procedure c2qEntity.Setshipping_region(Index: Integer; const Astring: string);
begin
  Fshipping_region := Astring;
  Fshipping_region_Specified := True;
end;

function c2qEntity.shipping_region_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_region_Specified;
end;

procedure c2qEntity.Setshipping_region_id(Index: Integer; const Astring: string);
begin
  Fshipping_region_id := Astring;
  Fshipping_region_id_Specified := True;
end;

function c2qEntity.shipping_region_id_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_region_id_Specified;
end;

procedure c2qEntity.Setshipping_city(Index: Integer; const Astring: string);
begin
  Fshipping_city := Astring;
  Fshipping_city_Specified := True;
end;

function c2qEntity.shipping_city_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_city_Specified;
end;

procedure c2qEntity.Setshipping_address(Index: Integer; const Astring: string);
begin
  Fshipping_address := Astring;
  Fshipping_address_Specified := True;
end;

function c2qEntity.shipping_address_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_address_Specified;
end;

procedure c2qEntity.Setshipping_postcode(Index: Integer; const Astring: string);
begin
  Fshipping_postcode := Astring;
  Fshipping_postcode_Specified := True;
end;

function c2qEntity.shipping_postcode_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_postcode_Specified;
end;

procedure c2qEntity.Setshipping_telephone(Index: Integer; const Astring: string);
begin
  Fshipping_telephone := Astring;
  Fshipping_telephone_Specified := True;
end;

function c2qEntity.shipping_telephone_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_telephone_Specified;
end;

procedure c2qEntity.Setshipping_fax(Index: Integer; const Astring: string);
begin
  Fshipping_fax := Astring;
  Fshipping_fax_Specified := True;
end;

function c2qEntity.shipping_fax_Specified(Index: Integer): boolean;
begin
  Result := Fshipping_fax_Specified;
end;

procedure c2qEntity.Setuser_id(Index: Integer; const Astring: string);
begin
  Fuser_id := Astring;
  Fuser_id_Specified := True;
end;

function c2qEntity.user_id_Specified(Index: Integer): boolean;
begin
  Result := Fuser_id_Specified;
end;

procedure c2qEntity.Setimported(Index: Integer; const Astring: string);
begin
  Fimported := Astring;
  Fimported_Specified := True;
end;

function c2qEntity.imported_Specified(Index: Integer): boolean;
begin
  Result := Fimported_Specified;
end;
...
procedure catalogCategoryInfo.Setinclude_in_menu(Index: Integer; const AInteger: Integer);
begin
  Finclude_in_menu := AInteger;
  Finclude_in_menu_Specified := True;
end;

function catalogCategoryInfo.include_in_menu_Specified(Index: Integer): boolean;
begin
  Result := Finclude_in_menu_Specified;
end;

procedure catalogCategoryInfo.Setcustom_use_parent_settings(Index: Integer; const AInteger: Integer);
begin
  Fcustom_use_parent_settings := AInteger;
  Fcustom_use_parent_settings_Specified := True;
end;

function catalogCategoryInfo.custom_use_parent_settings_Specified(Index: Integer): boolean;
begin
  Result := Fcustom_use_parent_settings_Specified;
end;

procedure catalogCategoryInfo.Setcustom_apply_to_products(Index: Integer; const AInteger: Integer);
begin
  Fcustom_apply_to_products := AInteger;
  Fcustom_apply_to_products_Specified := True;
end;

function catalogCategoryInfo.custom_apply_to_products_Specified(Index: Integer): boolean;
begin
  Result := Fcustom_apply_to_products_Specified;
end;

procedure catalogCategoryInfo.Setfilter_price_range(Index: Integer; const Astring: string);
begin
  Ffilter_price_range := Astring;
  Ffilter_price_range_Specified := True;
end;

function catalogCategoryInfo.filter_price_range_Specified(Index: Integer): boolean;
begin
  Result := Ffilter_price_range_Specified;
end;
...
initialization
  { PortType }
  InvRegistry.RegisterInterface(TypeInfo(PortType), 'urn:Magento', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(PortType), 'urn:Action');
  { PortType.catalogProductCreate }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductCreate', 'type_', 'type', '');
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductCreate', 'set_', 'set', '');
  { PortType.catalogProductAttributeMediaInfo }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductAttributeMediaInfo', 'file_', 'file', '');
  { PortType.catalogProductAttributeMediaUpdate }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductAttributeMediaUpdate', 'file_', 'file', '');
  { PortType.catalogProductAttributeMediaRemove }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductAttributeMediaRemove', 'file_', 'file', '');
  { PortType.catalogProductLinkList }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductLinkList', 'type_', 'type', '');
  { PortType.catalogProductLinkAssign }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductLinkAssign', 'type_', 'type', '');
  { PortType.catalogProductLinkUpdate }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductLinkUpdate', 'type_', 'type', '');
  { PortType.catalogProductLinkRemove }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductLinkRemove', 'type_', 'type', '');
  { PortType.catalogProductLinkAttributes }
  InvRegistry.RegisterParamInfo(TypeInfo(PortType), 'catalogProductLinkAttributes', 'type_', 'type', '');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(c2qEntityArray), 'urn:Magento', 'c2qEntityArray');
  ...
  RemClassRegistry.RegisterXSClass(quoteEntity, 'urn:Magento', 'quoteEntity');
  RemClassRegistry.RegisterXSClass(c2qEntity, 'urn:Magento', 'c2qEntity');
