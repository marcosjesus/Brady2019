object Fr_RelatGrossMargin: TFr_RelatGrossMargin
        ...
        object cxTabSheetBom: TcxTabSheet
          ...
          object cxGridBom: TcxGrid
            ...
            object cxTableViewBom: TcxGridDBTableView
              ...
              object cxTableViewBomDataProcessamento: TcxGridDBColumn
                Caption = 'Data Ref BOM'
                DataBinding.FieldName = 'Data Processamento'
              end
            end
        ...
        object cxTabSheetCosting: TcxTabSheet
          ...
          object cxGridCosting: TcxGrid
            ...
            object cxTableViewCosting: TcxGridDBTableView
              ...
              object cxTableViewCostingTSOP_DTIMPORTACAO: TcxGridDBColumn
                Caption = 'Data Ref Costing'
                DataBinding.FieldName = 'TSOP_DTIMPORTACAO'
              end
            end
        ...
        object cxTabSheetRouting: TcxTabSheet
          ...
          object cxGridRouting: TcxGrid
            ...
            object cxTableViewRouting: TcxGridDBTableView
              ...
              object cxTableViewRoutingDataProcessamento: TcxGridDBColumn
                Caption = 'Data Ref Routing'
                DataBinding.FieldName = 'Data Processamento'
              end
            end
  ...
  object FDQueryCosting: TFDQuery
    ...
    SQL.Strings = (
      ...
      'AND TSOP_DTIMPORTACAO = :V_TSOP_DTIMPORTACAO'
    ...
    object FDQueryCostingTSOP_DTIMPORTACAO: TSQLTimeStampField
      DisplayLabel = 'Data Processamento'
  ...
  object FDQueryBOM: TFDQuery
    ...
    object FDQueryBOMDataProcessamento: TSQLTimeStampField
      FieldName = 'Data Processamento'
      Origin = '[Data Processamento]'
      Required = True
    end
  end
  object FDQueryRouting: TFDQuery
    ...
    object FDQueryRoutingDataProcessamento: TSQLTimeStampField
      FieldName = 'Data Processamento'
      Origin = '[Data Processamento]'
      Required = True
    end
  ...
  object FDQueryVSOP_OrderBilling00: TFDQuery
    ...
    SQL.Strings = (
      ''
        ...
        ' ((a.totalnota / NULLIF(isnull(a.totalcustoprodutos,0))) - 1.000' +
        ') * 100 AS TotalMargem'
      
        '--FROM TB_C_VENDAS a WHERE a.numeronota > 0 AND a.tipooperacao =' +
        ' '#39'V'#39
      ''
      'DECLARE @V_BILLING_INI DATETIME'
      'DECLARE @V_BILLING_FIM DATETIME'
      'DECLARE @V_COSTREF DATETIME'#9
      'DECLARE @V_BOMREF DATETIME'#9
      'DECLARE @V_TSOP_GMHBUD VARCHAR(1)'#9
      ''
      ''
      ...
      ''
        ...
        'e'
      #9#9#9#9#9'  AND TSOP_GMCBUD = '#39'E'#39
