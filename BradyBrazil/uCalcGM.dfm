object Fr_CalcGM: TFr_CalcGM
  ...
  object FDQueryItemBom: TFDQuery
    Connection = FDConnection
    SQL.Strings = (
      'select * from TMAQ_ItemBOM where 1=1')
    Left = 52
    Top = 305
    object FDQueryItemBomTMAQ_ITEBOMCOD: TFDAutoIncField
      FieldName = 'TMAQ_ITEBOMCOD'
      Origin = 'TMAQ_ITEBOMCOD'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDQueryItemBomTMAQ_ITEBOMITECOD: TStringField
      FieldName = 'TMAQ_ITEBOMITECOD'
      Origin = 'TMAQ_ITEBOMITECOD'
      Required = True
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMSIT: TStringField
      FieldName = 'TMAQ_ITEBOMSIT'
      Origin = 'TMAQ_ITEBOMSIT'
      Required = True
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMITEMPRCOD: TStringField
      FieldName = 'TMAQ_ITEBOMITEMPRCOD'
      Origin = 'TMAQ_ITEBOMITEMPRCOD'
      Required = True
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMITEMTRTYP: TStringField
      FieldName = 'TMAQ_ITEBOMITEMTRTYP'
      Origin = 'TMAQ_ITEBOMITEMTRTYP'
      Required = True
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMITEMPRQTDBAS: TBCDField
    ...
    object FDQueryItemBomTMAQ_ITEBOMITEMPRFIX: TStringField
    ...
    object FDQueryItemBomTMAQ_ITEBOMITEMPRQTD: TBCDField
    ...
    object FDQueryItemBomTMAQ_ITEBOMITEMPRQTDREF: TBCDField
    ...
    object FDQueryItemBomTMAQ_ITEBOMITEMPRCOSREL: TStringField
      FieldName = 'TMAQ_ITEBOMITEMPRCOSREL'
      Origin = 'TMAQ_ITEBOMITEMPRCOSREL'
      Required = True
      Size = 1
    end
    object FDQueryItemBomTMAQ_ITEBOMITEMPRBUK: TStringField
      FieldName = 'TMAQ_ITEBOMITEMPRBUK'
      Origin = 'TMAQ_ITEBOMITEMPRBUK'
      Required = True
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMITEMPRUOM: TStringField
      FieldName = 'TMAQ_ITEBOMITEMPRUOM'
      Origin = 'TMAQ_ITEBOMITEMPRUOM'
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMORDPRO: TStringField
      FieldName = 'TMAQ_ITEBOMORDPRO'
      Origin = 'TMAQ_ITEBOMORDPRO'
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMSALORD: TStringField
      FieldName = 'TMAQ_ITEBOMSALORD'
      Origin = 'TMAQ_ITEBOMSALORD'
      Size = 255
    end
    object FDQueryItemBomTMAQ_ITEBOMSALORDITE: TIntegerField
      FieldName = 'TMAQ_ITEBOMSALORDITE'
      Origin = 'TMAQ_ITEBOMSALORDITE'
    end
    object FDQueryItemBomTMAQ_ITEBOMDAT: TSQLTimeStampField
      FieldName = 'TMAQ_ITEBOMDAT'
      Origin = 'TMAQ_ITEBOMDAT'
      Required = True
    end
  end
  object FDQueryCusto: TFDQuery
    Connection = FDConnection
    SQL.Strings = (
      ''
      'select * from TSOP_GMCustos where 1 = 1')
    Left = 156
    Top = 297
    object FDQueryCustoTSOP_GMCCOD: TFDAutoIncField
      FieldName = 'TSOP_GMCCOD'
      Origin = 'TSOP_GMCCOD'
      ReadOnly = True
    end
    object FDQueryCustoTSOP_GMCITE: TStringField
      FieldName = 'TSOP_GMCITE'
      Origin = 'TSOP_GMCITE'
      Required = True
    end
    object FDQueryCustoTSOP_GMCSIT: TStringField
      FieldName = 'TSOP_GMCSIT'
      Origin = 'TSOP_GMCSIT'
      Required = True
    end
    object FDQueryCustoTSOP_GMCLOT: TBCDField
    ...
    object FDQueryCustoTSOP_GMCDAT: TSQLTimeStampField
      FieldName = 'TSOP_GMCDAT'
      Origin = 'TSOP_GMCDAT'
      Required = True
    end
    object FDQueryCustoTSOP_GMCCUSSTD: TBCDField
    ...
    object FDQueryCustoTSOP_GMCCUSMOV: TBCDField
    ...
    object FDQueryCustoTSOP_GMCPRIUNI: TBCDField
    ...
    object FDQueryCustoTSOP_GMCBUD: TStringField
      FieldName = 'TSOP_GMCBUD'
      Origin = 'TSOP_GMCBUD'
      Size = 1
    end
    object FDQueryCustoTSOP_DTIMPORTACAO: TSQLTimeStampField
  ...
  object FDQueryRouting: TFDQuery
    ...
    object FDQueryRoutingTMAQ_ITEROUSIT: TStringField
      FieldName = 'TMAQ_ITEROUSIT'
      Origin = 'TMAQ_ITEROUSIT'
      Size = 50
    end
    object FDQueryRoutingTMAQ_ITEROUITECOD: TStringField
      FieldName = 'TMAQ_ITEROUITECOD'
      Origin = 'TMAQ_ITEROUITECOD'
      Required = True
      Size = 255
    end
    object FDQueryRoutingTMAQ_ITEROUDATINI: TSQLTimeStampField
      FieldName = 'TMAQ_ITEROUDATINI'
      Origin = 'TMAQ_ITEROUDATINI'
      Required = True
    end
    object FDQueryRoutingTMAQ_ITEROUWKCCOD: TStringField
      FieldName = 'TMAQ_ITEROUWKCCOD'
      Origin = 'TMAQ_ITEROUWKCCOD'
      Required = True
      Size = 255
    end
    object FDQueryRoutingTMAQ_ITEROUCCU: TStringField
      FieldName = 'TMAQ_ITEROUCCU'
      Origin = 'TMAQ_ITEROUCCU'
      Required = True
      Size = 255
    end
    object FDQueryRoutingTMAQ_ITEROUCTR: TStringField
      FieldName = 'TMAQ_ITEROUCTR'
      Origin = 'TMAQ_ITEROUCTR'
      Required = True
      Size = 255
    end
    object FDQueryRoutingTMAQ_ITEROUOPE: TIntegerField
      FieldName = 'TMAQ_ITEROUOPE'
      Origin = 'TMAQ_ITEROUOPE'
      Required = True
    end
    object FDQueryRoutingTMAQ_ITEROUTXT: TStringField
      FieldName = 'TMAQ_ITEROUTXT'
      Origin = 'TMAQ_ITEROUTXT'
      Required = True
      Size = 255
    end
    object FDQueryRoutingTMAQ_ITEROUQTDBAS: TBCDField
    ...
    object FDQueryRoutingTMAQ_ITEROUMINSEP: TBCDField
    ...
    object FDQueryRoutingTMAQ_ITEROUMINMAC: TBCDField
    ...
    object FDQueryRoutingTMAQ_ITEROUMINLAB: TBCDField
    ...
    object FDQueryRoutingTMAQ_ITEROUMINOVE: TBCDField
    ...
    object FDQueryRoutingTMAQ_ITEROUDAT: TSQLTimeStampField
