...
Uses
	 ...
	 rsFlyovr, rsEdit, ComCtrls, Mask, extctrls;
...
Procedure FillListByQyery ( L : TStringList ; Q : TQuery ; F : String ) ; Export ;
...
Function Obj_FillCombo ( Combo : TComboBox ; Sql : String ) : Boolean ; Export ;
...
Procedure FillListByQyery ( L : TStringList ; Q : TQuery ; F : String ) ;
Begin
   Q.First ;
   L.Clear ;
   While ( Not Q.Eof ) Do
...
//               foFullDate : TrsSuperEdit(Comp).AsDateTime := Value ;
				  foFullDate : TrsSuperEdit(Comp).Text := Value ;
...
Function Obj_FillCombo ( Combo : TComboBox ; Sql : String ) : Boolean ;
Var
   Q : TQuery ;
   Tab : TSqlTable ;
