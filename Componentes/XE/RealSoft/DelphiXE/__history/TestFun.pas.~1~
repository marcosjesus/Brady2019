...
Function Test_DateOk ( Const S : String ) : Boolean ; Export ;
Function Test_StrInSet( Const S,StrSet:String;Len:Integer;IsCase:Boolean):Boolean ; Export ;
...
Function Test_StrInSet ( Const S : String ; Const StrSet : String ; Len : Integer ; IsCase : Boolean ) : Boolean ;
Var
   vS, vStrSet : String ;
Begin
   Result := False ;
