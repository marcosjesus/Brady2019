...
begin
 case ACodCidade of
  ...
  2301109: begin // Aracati/CE
            ConfigURL.HomNomeCidade := 'arq';
            ConfigURL.ProNomeCidade := 'arq';
           end;
  2301901: begin //Barbalha/CE
            ConfigURL.HomNomeCidade := 'bar';
            ConfigURL.ProNomeCidade := 'bar';
           end;
  2302206: begin//Beberibe/CE
            ConfigURL.HomNomeCidade := 'beb';
            ConfigURL.ProNomeCidade := 'beb';
           end;
  2304202: begin //Crato/CE
            ConfigURL.HomNomeCidade := 'crt';
            ConfigURL.ProNomeCidade := 'crt';
           end;
  2305001: begin //Guaraciaba do Norte/CE
            ConfigURL.HomNomeCidade := 'gua';
            ConfigURL.ProNomeCidade := 'gua';
           end;
  2306256: begin //Itaitinga/CE
            ConfigURL.HomNomeCidade := 'ita';
            ConfigURL.ProNomeCidade := 'ita';
           end;
  2307254: begin //Jijoca/CE
            ConfigURL.HomNomeCidade := 'jij';
            ConfigURL.ProNomeCidade := 'jij';
           end;
  2307650: begin // Maracanaú
            ConfigURL.HomNomeCidade := 'mar';
            ConfigURL.ProNomeCidade := 'mar';
           end;
  2611101: begin // Petrolina
            ConfigURL.HomNomeCidade := 'pet';
            ConfigURL.ProNomeCidade := 'pet';
           end;
  2310852: begin //Pindoretama/CE
            ConfigURL.HomNomeCidade := 'pin';
            ConfigURL.ProNomeCidade := 'pin';
           end;
  2311405: begin //Quixeramobim/CE
            ConfigURL.HomNomeCidade := 'qxb';
            ConfigURL.ProNomeCidade := 'qxb';
           end;
  2313302: begin //Tauá/CE
            ConfigURL.HomNomeCidade := 'tau';
            ConfigURL.ProNomeCidade := 'tau';
           end;
