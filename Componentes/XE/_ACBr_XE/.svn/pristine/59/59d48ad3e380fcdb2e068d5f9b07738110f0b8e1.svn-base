 ...
 with ACBrNFSe1 do
  begin
   ...
   with NotasFiscais.Add.NFSe do
    begin
     // Somente o provedor Infisc
     Numero := NumNFSe;
     SeriePrestacao := 'S';
     Randomize;
     codigoNumerico := Random(999999999) + 1;

     ChaveNFSe := Copy(edtCodCidade.Text, 1, 2) +
                  edtEmitCNPJ.Text +
                  '98' + // Modelo
                  '00' + SeriePrestacao +
                  FormatFloat('000000000', StrToInt(NumNFSe)) +
                  FormatFloat('000000000', CodigoNumerico);
...
//     RegimeEspecialTributacao := retNenhum;
     ...
     *)
     ...
     Servico.Valores.ValorServicos          := 15.00;
    ...
    // Somente o provedor SimplISS permite infomar mais de 1 serviço
     ...
     Prestador.InscricaoEstadual  := '123456';
     ...
     PrestadorServico.Contato.Email := edtEmailRemetente.Text;
     ...
     *)
     ...
     // Somente o provedor Infisc permite infomar as faturas
     with CondicaoPagamento.Parcelas.Add do
      begin
        Parcela := 1;
        DataVencimento := Date + 10;
        Valor := Servico.Valores.ValorServicos;
      end;
    end;
