...
const
  cURL_Homologacao = 'http://186.225.138.210:5663/IssWeb-ejb/IssWebWS/IssWebWS?wsdl';
begin
 // URL de produção
 case ACodCidade of
  1100114 : // Jaru
...
//   acConsNFSe:    Result := SeparaDados( RetornoWS, 'ns3:consultarNfseResponse' );
   ...
   acCancelar:    begin
                    Result := SeparaDados( RetornoWS, 'ns2:cancelarNfseResposta' );
                    Result := '<ns2:cancelarNfseResposta ' +
