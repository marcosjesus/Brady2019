...
begin
 ...
 if AProvedor in [proNenhum, proABRASFv1, proABRASFv2, pro4R, proAgili,
                  ...
                  proSystemPro, proEReceita] then Result := '';
end;
...
begin
 ...
 if NumeroNFSe <> '' then
 begin
  if AProvedor in [proPVH, proSystemPro, proPublica, proSisPMJP, proEReceita] then
...
*)
 ...
 if AProvedor in [proFiorilli, profintelISS, proPVH, proSystemPro, proSisPMJP, proEReceita]
