...
uses
  ...
  {$IF CompilerVersion >= 23}, Vcl.Imaging.jpeg{$else}, jpeg{$ifend};
       ...
       begin
         ...
         try
           try
             ...
             rliPrestLogo.Picture.Graphic.LoadFromStream(vStringStream);
           end;
         finally
           vStringStream.Free;
         end;
...
procedure TfrlDANFSeRLRetrato.RLNFSeNeedData(Sender: TObject;
