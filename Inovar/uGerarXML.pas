...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Items.Text := StringReplace( Items.Text, '%ano_ref%', FormatFloat('0000', StrToInt(dInovarAuto.FDMemTableNotaFiscalano.AsString)/1), [rfReplaceAll] );
      ...
      XML.SaveToFile( ExtractFilePath(Application.ExeName) + '01111039000491_V_' + FormatDateTime( 'mm_yyyy' , DataInicial ) + '.xml' );
